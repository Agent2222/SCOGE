...
class uniDomainDev extends HTMLElement {
    ...
    loadStats() {
        ...
        if (this.blueGel != 0) {
            this.shadowRoot.getElementById('ii2').src = "https://storage.scoge.co/scogeUniverse/digisette/Blue-DigiGel-1.png";
            if (this.blueGel > 1) {
                this.shadowRoot.getElementById('ii3multi').innerHTML = `( <span class="gelQty">${this.blueGel - 1}</span> )`;
            }
        }
        if (this.redGel != 0) {
            this.shadowRoot.getElementById('ii3').src = "https://storage.scoge.co/scogeUniverse/digisette/Red-DigiGel-1.png";
            if (this.redGel > 1) {
        ...
        if (this.goldGel != 0) {
            this.shadowRoot.getElementById('ii4').src = "https://storage.scoge.co/scogeUniverse/digisette/Yellow-DigiGel-1.png";
            if (this.goldGel > 1) {
        ...
        if (this.whiteGel != 0) {
            this.shadowRoot.getElementById('ii5').src = "https://storage.scoge.co/scogeUniverse/digisette/White-DigiGel-1.png";
            if (this.whiteGel > 1) {
                ...
                <div id="mainCont">
                    ...
                    <div id="assetsCont">
                        <div class="inventoryItem" id="assetDigisette">
                            <img src="https://storage.scoge.co/scogeUniverse/digisette/Digisette-1-2.png" alt="digisette">
                            <div class="multiplier" id="ii1multi">001</div>
                        </div>
                        <div class="inventoryItem" id="inventoryItem1">
                            <img id="ii1" data-help="GelCase" src="https://storage.scoge.co/scogeUniverse/digisette/Clear-DigiGelCase-1.png">
