...
class mobileShop1 extends HTMLElement {
  ...
  loadShop = async () => {
    ...
    allProducts[0].forEach((product) => {
      ...
      this.shadow
        .getElementById("productEdition")
        .addEventListener("click", this.toggleTerms);
    ...
    currentShopProduct[0].assets.forEach((image) => {
      ...
      if (image.filename === "sizeChart.png") {
        this.shadow.getElementById("noti").innerHTML = `
              ...
              `;
        this.shadow
          .getElementById("pSizeGuide")
          .addEventListener("click", this.noti1);
      }
    });
  ...
  checkSize = () => {
    currentShopProduct[0].variant_groups[0].options.forEach((size) => {
      ...
      this.shadow
        .getElementById(`${size.name}`)
        .addEventListener("click", this.selectSize);
  ...
  noti1 = () => {
    ...
    if (pComplete === true) {
      ...
      this.shadow
        .getElementById("noti")
        .addEventListener("click", this.closeNoti);
    }
  };
  closeNoti = () => {
  ...
  changeToMainPic = (e) => {
    ...
    this.shadow.getElementById("mainImageCont").src = `${selectedImg}`;
  };
  ...
  return = () => {
    ...
    switch (shopPage) {
      ...
      case 3:
        ...
        this.shadow
          .getElementById("cartStatus")
          .removeEventListener("click", this.checkout);
        this.shadow
          .getElementById("cartStatus")
          .addEventListener("click", this.viewCart);
      ...
      case 5:
        ...
        this.shadow
          .getElementById("noti")
          .removeEventListener("click", this.return);
        this.returnSize();
        selectedPSize = "";
        shopPage = 1;
        this.shadow.getElementById(
  ...
  addToCart = async () => {
    ...
    var selectedVariant =
      currentShopProduct[0].variant_groups[0].options.filter((variant) => {
            ...
            commerce.cart
              ...
              .then(() => {
                ...
                commerce.cart.retrieve().then((cart) => {
                  currentCart = cart;
                  this.shadow.getElementById("LoadBG").style.display = "none";
                  this.shadow.getElementById("addItemButton").innerHTML =
                    "< SELECT SIZE";
                  this.shadow.getElementById("cartStatus").innerHTML =
                    "VIEW CART";
                  var sizeElements =
                    this.shadow.querySelectorAll(".sizeButtons");
  ...
  viewCart = () => {
    ...
    this.shadow
      ...
      .addEventListener("click", this.shipping);
    ...
    currentCart.line_items.forEach((lineitem) => {
      ...
      this.shadow.getElementById("cartItems").appendChild(lineItemElement);
  ...
  changeQty = (e) => {
    ...
    if (e.target.getAttribute("name") === "inc") {
      ...
      if (qty >= 2 && selectedItem[0].quantity <= qty - 1) {
        commerce.cart
          .update(`${item}`, { quantity: selectedItem[0].quantity + 1 })
          .then((response) => {
            this.shadow.getElementById("cartItems").innerHTML = "";
            this.shadow.getElementById("LoadBG").style.display = "none";
            this.shadow.getElementById("totalPrice").innerHTML =
  ...
  shipping = () => {
    ...
    this.shadow
      .getElementById("inputCN")
      .addEventListener("change", this.states);
      ...
      .then(async (checkout) => {
        commerce.checkout
          ...
          .then(async (response) => {
            ...
            var fullName = `${fn} ${ln}`;
            const paymentMethodResponse = await stripeElements
              .createPaymentMethod({
                type: "card",
                card,
              })
  ...
  connectedCallback() {
    ...
    this.shadow
      ...
      .addEventListener("click", this.return.bind(this));
  ...
  render() {
    this.shadow.innerHTML = `
         <style>
            ...
            @font-face {
                font-family: "BS-I";
                src: url("https://storage.scoge.co/scogeFonts/fonts/BioSans-Italic.svg");
                font-weight: normal;
                font-style: italic;
            }
            :root {
