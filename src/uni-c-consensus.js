    ...
    selectCategory(e) {
        ...
        this.shadow.querySelectorAll('.voteCategory').forEach((el) => {
            ...
            if (e.target.classList.contains("voteCategory")) {
                ...
                switch (el.id) {
                    case 'vcBottoms':
                        catImage.src = "https://storage.fleek-internal.com/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Universe/avatar/avatar-pants1.png";
                        voteText.innerHTML = "BOTTOMS";
                        this.selectCategory = 'vcBottoms';
                    break;
                    case 'vcSuits':
                        catImage.src = "https://storage.fleek-internal.com/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Universe/avatar/avatar-suit1.png";
                        voteText.innerHTML = "SUITS";
                        this.selectCategory = 'vcSuits';
                    break;
                    case 'vcTop':
                        catImage.src = "https://storage.fleek-internal.com/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Universe/avatar/avatar-top1.png";
                        voteText.innerHTML = "TOPS";
                        this.selectCategory = 'vcTop';
                    break;
                    case 'vcShoes':
                        catImage.src = "https://storage.fleek-internal.com/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Universe/avatar/avatar-shoes1.png";
                        voteText.innerHTML = "SHOES";
                        this.selectCategory = 'vcShoes';
                    break;
                    case 'vcHead':
                        catImage.src = "https://storage.fleek-internal.com/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Universe/avatar/avatar-head1.png";
                        voteText.innerHTML = "HEAD";
                        this.selectCategory = 'vcHead';
                    break;
                    case 'vcHands':
                        catImage.src = "https://storage.fleek-internal.com/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Universe/avatar/avatar-hands1.png";
                    ...
                    break;
                    case 'vcTshirt':
                        catImage.src = "https://storage.fleek-internal.com/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Universe/avatar/avatar-tshirt1.png";
                        voteText.innerHTML = "T-SHIRT";
                        this.selectCategory = 'vcTshirt';
                    break;
                    case 'vcShorts':
                        catImage.src = "https://storage.fleek-internal.com/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Universe/avatar/avatar-shorts1.png";
            ...
            <div id="view">
                ...
                <div id="visualSection">
                    ...
                    <div id="pecentageBlock">
                        <div id="avatar">
                            <div id="avatarImg">
                                <img id="avImg" src="https://storage.fleek-internal.com/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Universe/avatar/avatar-suit1.png" alt="">
                            </div>
                            <div id="avatarBase">
