...
class getWallet extends HTMLElement {
  constructor() {
    super();
  ...
  connectedCallback() {
    ...
    this.shadow
      ...
      .addEventListener("click", this.closeGetWallet.bind(this));
    this.shadow.getElementById("plugIcon").addEventListener('click', this.goGetPlug);
    this.shadow.getElementById("getPlug2").addEventListener('click', this.goGetPlug);
    this.shadow.getElementById("reload").addEventListener('click', () => {
        location.reload();
    })
...
customElements.define("get-wallet", getWallet);
