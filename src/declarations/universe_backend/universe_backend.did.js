export const idlFactory = ({ IDL }) => {
  ...
  const NMCProperties = IDL.Record({
    'xp' : IDL.Opt(IDL.Nat64),
    'earthImage' : IDL.Opt(IDL.Vec(IDL.Nat8)),
    'bankooText' : IDL.Opt(IDL.Vec(IDL.Text)),
    'mental' : IDL.Opt(IDL.Nat64),
    'powerUps' : IDL.Opt(IDL.Vec(IDL.Nat64)),
    'styles' : IDL.Opt(IDL.Vec(IDL.Text)),
    'alias' : IDL.Text,
    'notiOn' : IDL.Opt(IDL.Bool),
    'netClass' : IDL.Opt(IDL.Text),
    'data' : IDL.Opt(IDL.Vec(IDL.Nat8)),
    'fsOn' : IDL.Opt(IDL.Bool),
    'rank' : IDL.Nat64,
    'network' : IDL.Opt(IDL.Vec(IDL.Text)),
    'ancestorsNames' : IDL.Opt(IDL.Vec(IDL.Text)),
    'email' : IDL.Text,
    'bankooImage' : IDL.Opt(IDL.Vec(IDL.Nat8)),
    'sight' : IDL.Opt(IDL.Nat64),
    'speed' : IDL.Opt(IDL.Nat64),
    'discoveredProgress' : IDL.Opt(IDL.Float64),
    'story' : IDL.Opt(IDL.Text),
    'imageURI' : IDL.Text,
    'progress' : IDL.Nat64,
    'musicLevel' : IDL.Opt(IDL.Float64),
    'domains' : IDL.Opt(IDL.Vec(IDL.Nat64)),
    'landRank' : IDL.Nat64,
    'pillType' : IDL.Text,
    'category' : IDL.Text,
    'landNumber' : IDL.Nat64,
    'endurance' : IDL.Opt(IDL.Float64),
    'power' : IDL.Opt(IDL.Nat64),
    'physical' : IDL.Opt(IDL.Nat64),
    'identifier' : IDL.Text,
    'videoURI' : IDL.Opt(IDL.Text),
    'ancestorsImages' : IDL.Opt(IDL.Vec(IDL.Nat8)),
    'soundLevel' : IDL.Opt(IDL.Float64),
    'earthText' : IDL.Opt(IDL.Vec(IDL.Text)),
    'linked' : IDL.Opt(IDL.Bool),
    'playerLocation' : IDL.Nat64,
    'health' : IDL.Opt(IDL.Nat64),
