import{n as Q,g as X,a as Z}from"./main-DMAOip2U.js";import"./wScoge-DGG5VK00.js";var U=null,v=null,B=null,f=null,e=null,c=null,C=0,w=0,_=!1,R=null,ee={name:"newScene",position:0,type:"dialogue",bg:"rgba(0,0,0,0.75)",activated:{land:0,pop:!1,gate:0,scn:[]},characters:[],elements:[]},F={name:"newScene",position:0,type:"dialogue",bg:"rgba(0,0,0,0.75)",activated:{land:0,pop:!1,gate:0,scn:[]},characters:[],elements:[]},S={id:"newElement",type:"div",src:"https://storage.fleek-internal.com/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Universe/Elements/charTemplate.png",left:"auto",right:"10%",bottom:"auto",top:"5%",zIndex:"3",width:"auto",height:"30%",speed:.9,shadow:!0,shadowEffect:"0px",brightness:"1.0",leftTo:"",rightTo:"",bottomTo:"",topTo:"",zIndexTo:"",widthTo:"",heightTo:"",shadowEffectTo:"",brightnessTo:"",action:""},I={persona:{name:"newCharacter",location:"newLocation",job:"newJob",dialogue:{intro:"Hello, I will become a new character."},images:{default:"https://storage.fleek-internal.com/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Universe/Characters/char-template.png"}},pns:{position:"absolute",left:"10%",leftTo:"12%",right:"auto",rightTo:"auto",bottom:0,bottomTo:0,top:"auto",topTo:"auto",zIndex:1,zIndexTo:1,width:"auto",widthTo:"auto",height:"80%",heightTo:"80%",speed:1,blur:"0px",blurTo:"0px",brightness:"1",brightnessTo:"1"},element:{class:"chr-textElement",type:"div",backgroundColor:"rgba(0,0,0,0.75)",padding:"10px 10px",borderRadius:"10px",borderTop:"0.5px solid rgb(255, 0, 45)",borderBottom:"0.5px solid rgb(255, 0, 45)",width:"350px",height:"auto",left:"auto",right:"-10%",bottom:"auto",top:"-6%",zIndex:2,position:"absolute",border:".5px solid #ff002d",pointer:{position:"absolute",width:"50px",height:"50px",borderLeft:"1px solid #ff002d",bottom:"-60px",left:"-30px",zIndex:-5,transform:"rotate(45deg)"}},actions:["chat"]};async function ne(Y){var J;try{const x=await fetch("/src/sudb.json");if(!x.ok)throw new Error(`HTTP error! Status: ${x.status}`);U=await x.json(),v=U,B=U.SUD.Scenarios.Intro}catch(x){console.error("Error fetching JSON data:",x)}if(Y===!1){const x=document.createElement("link");x.rel="stylesheet",x.href="editor.css",document.head.appendChild(x);var W=document.createElement("div"),O=document.getElementById("main");W.setAttribute("id","editorScreen"),W.innerHTML=`
        ...
        `,O.appendChild(W),document.getElementById("loadScene").addEventListener("click",()=>{document.getElementById("editorbodyDisplay").appendChild(document.querySelector(".currentScene"))}),document.getElementById("aiAsstSelectScope").addEventListener("change",()=>{R=document.getElementById("aiAsstSelectScope").value});var q=document.getElementById("scenarioDropdown");for(const a in v.SUD.Scenarios){var P=document.createElement("option");P.setAttribute("value",a),P.innerHTML=a,q.appendChild(P)}f=q.value,q.addEventListener("change",()=>{var o,i;var a=v.SUD.Scenarios[q.value];B=v.SUD.Scenarios[q.value],document.getElementById("scenesContainer").innerHTML="",a.forEach(s=>{var t=document.createElement("div");t.setAttribute("class","sceneSelectElement"),t.setAttribute("id",s.name),t.innerHTML=`${s.name}`,t.addEventListener("click",l=>{G(l.target.id)}),document.getElementById("scenesContainer").appendChild(t)});var r=document.createElement("div");r.setAttribute("class","sceneSelectElement"),r.setAttribute("id","newSceneBut"),r.innerHTML="[ NEW SCENE ]",document.getElementById("scenesContainer").appendChild(r),j(),_&&((o=document.querySelector(".currentScene"))==null||o.remove(),G((i=a[0])==null?void 0:i.name,0))}),B.forEach(a=>{v=U;var r=document.createElement("div");r.setAttribute("class","sceneSelectElement"),r.setAttribute("data-position",a.position-1),r.setAttribute("id",a.name),r.innerHTML=`${a.name}`,a.name==="scene1"?r.innerHTML=`${a.name}<span style="float:right; color: var(--accent)">&#9679;</span>`:r.innerHTML=`${a.name}`,r.addEventListener("click",o=>{var s;if(e.elements.find(({id:t})=>t.includes("newElementUnsaved"))&&(e.elements=e.elements.filter(({id:t})=>!t.includes("newElementUnsaved"))),e.characters.find(({persona:t})=>t.name.includes("newCharacterUnsaved"))&&(e.characters=e.characters.filter(({persona:t})=>!t.name.includes("newCharacterUnsaved"))),_){var i=o.target.getAttribute("data-position");(s=document.querySelectorAll(".currentScene")[0])==null||s.remove(),G(o.target.id,i)}document.getElementById("headerSceneName").style.color="yellow",setTimeout(()=>{document.getElementById("headerSceneName").style.color="#ff002d"},1e3)}),document.getElementById("scenesContainer").appendChild(r)});const G=(a,r)=>{var o,i,s;C=0,w=0,document.querySelector(".currentScene")===null&&(Q(`${f}`,r),setTimeout(()=>{var t;(t=document.getElementById("editorbodyDisplay"))==null||t.appendChild(document.querySelector(".currentScene"))},1e3)),document.querySelectorAll(".sceneSelectElement").forEach(t=>{document.getElementById("scnAttName").setAttribute("class","attInput"),document.getElementById("headerSceneName").removeAttribute("class"),t.id===a?document.getElementById(a).innerHTML=`${a}<span style="float:right; color: var(--accent)">&#9679;</span>`:document.getElementById(t.id).innerHTML=`${t.id}`});for(const t in B)B[t].name===a&&(e=B[t],document.getElementById("hsc").innerHTML=`${B[t].activated}]`,document.getElementById("headerSceneName").innerHTML=`${B[t].name}`,document.getElementById("scnAttName").value=`${B[t].name}`,document.getElementById("scnAttType").value=`${B[t].type}`,document.getElementById("scnAttBg").value=`${B[t].bg}`,document.getElementById("scnAttAct1").value=`${B[t].activated.land}`,document.getElementById("scnAttAct2").value=`${B[t].activated.pop}`,B[t].activated.pop===!0?document.getElementById("scnAttAct2").selectedIndex=0:document.getElementById("scnAttAct2").selectedIndex=1,document.getElementById("scnAttAct3").value=`${B[t].activated.gate}`,document.getElementById("scnAttAct4").value=`${parseInt((o=B[t].activated.scn)==null?void 0:o.join(""))}`,document.getElementById("inSceneChars").innerHTML="",document.getElementById("inSceneEls").innerHTML="",B[t].characters.forEach(l=>{var y=document.createElement("div");if(y.setAttribute("class","inSceneCard"),y.setAttribute("id",l.persona.name),y.innerHTML=`${l.persona.name}`,document.getElementById("inSceneChars").appendChild(y),"element"in l){var p=document.createElement("div");p.setAttribute("class","inSceneCard"),p.setAttribute("id",`${l.persona.name}-dia`),p.innerHTML=`${l.persona.name} - ${l.actions[0]}`,document.getElementById("inSceneCharsDialogues").innerHTML="",document.getElementById("inSceneCharsDialogues").appendChild(p),p.addEventListener("click",h=>{K(h.target.id),l.persona.dialogue.pPosition==="left"?document.getElementById("charAttTalkInput").value="left":document.getElementById("charAttTalkInput").value="right"})}y.addEventListener("click",h=>{H(h.target.id)})}),(i=B[t].elements)==null||i.forEach(l=>{var y=document.createElement("div");y.setAttribute("class","inSceneCard"),y.setAttribute("id",l.id),y.innerHTML=`${l.id}`,document.getElementById("inSceneEls").appendChild(y),y.addEventListener("click",p=>{z(p.target.id)})}));_===!0&&document.querySelectorAll(".sceneSelectElementChar").forEach(t=>{t.remove()}),_===!0&&document.querySelectorAll(".sceneSelectElementEl").forEach(t=>{t.remove()}),v.SUD.Characters.forEach(t=>{var l=document.createElement("div"),y=document.getElementById("newCharBut");y.innerHTML="[ NEW CHARACTER ]",l.setAttribute("class","sceneSelectElementChar"),l.setAttribute("id",`${t.name}_global`);var p=e.characters.find(({persona:g})=>g.name===t.name);if(p)l.innerHTML=`${t.name}<span style="float:right; color: var(--accent)">&#9679;</span>`,l.addEventListener("click",g=>{H(g.target.id.replace("_global",""),t.name)});else{l.innerHTML=`${t.name}`;var h=()=>{C++;var g=document.createElement("div");g.setAttribute("class","inSceneCard pendingSaveCard"),g.setAttribute("id",`newCharacterUnsaved-${C}`),g.innerHTML=`${t.name}`,document.getElementById("inSceneChars").appendChild(g),g.addEventListener("click",T=>{H(T.target.id.replace("_global",""),t.name)}),l.removeEventListener("click",h),l.innerHTML=`${t.name}<span style="float:right; color: yellow">&#9679;</span>`};l.addEventListener("click",h),l.setAttribute("data-listener","true")}document.getElementById("charactersContainer").appendChild(l),document.getElementById("charactersContainer").appendChild(y)}),(s=v.SUD.Elements)==null||s.forEach(t=>{var g;var l=document.createElement("div"),y=document.getElementById("newElBut");y.innerHTML="[ NEW ELEMENT ]",l.setAttribute("class","sceneSelectElementEl"),l.setAttribute("id",`${t.id}_global`);var p=(g=e.elements)==null?void 0:g.find(({id:T})=>T===t.id);if(p)l.innerHTML=`${t.id}<span style="float:right; color: var(--accent)">&#9679;</span>`,l.addEventListener("click",T=>{z(T.target.id.replace("_global",""))});else{l.innerHTML=`${t.id}`;var h=()=>{w++;var T=document.createElement("div");T.setAttribute("class","inSceneCard pendingSaveCard"),T.setAttribute("id",`"newElementUnsaved"-${w}`),T.innerHTML=`${t.id}}`,document.getElementById("inSceneEls").appendChild(T),T.addEventListener("click",L=>{z(L.target.id.replace("_global",""),t.id)}),l.removeEventListener("click",h),l.innerHTML=`${t.id}<span style="float:right; color: var(--accent)">&#9679;</span>`};l.addEventListener("click",h),l.setAttribute("data-listener","true")}document.getElementById("elsContainer").appendChild(l),document.getElementById("elsContainer").appendChild(y)}),_=!0};G("scene1",0),document.getElementById("summonAI").addEventListener("click",async()=>{document.getElementById("editorAiOutput").innerHTML="Loading...",document.getElementById("editorUserInput").value,document.getElementById("editorUserInput").value="",document.getElementById("editorAiOutput").innerHTML=`${completion.data.choices[0].message.content}`});const H=(a,r)=>{var D,d,A,$,m;var o=document.querySelector(".currentScene"),i=Array.from(o.childNodes);if(!i.find(n=>n.id.includes(`${`char_${a}`}`)))if(a.includes("newCharacterUnsaved-")){I.persona.name=a;var s=document.createElement("div"),t=document.createElement("img");s.classList.add("sceneElement"),s.setAttribute("id",`char_${a}`),t.setAttribute("src",((D=v.SUD.Characters.find(({name:n})=>n===r))==null?void 0:D.images.default)||I.persona.images.default),s.appendChild(t),s.style.height=I.pns.height,s.style.width=I.pns.width,s.style.left=I.pns.left,s.style.right=I.pns.right,s.style.top=I.pns.top,s.style.position=I.pns.position,s.style.zIndex=I.pns.zIndex,s.style.position="absolute",s.style.opacity="1",t.style.width="auto",t.style.height="100%",t.style.objectFit="contain",document.querySelector(".currentScene").appendChild(s),e==null||e.characters.push(I)}else{I.persona.name=a;var l=document.createElement("div"),y=document.createElement("img"),p=document.createElement("div");p.setAttribute("class","inSceneCard pendingSaveCard"),p.setAttribute("id",`${a}`),p.innerHTML=`${a}`,p.addEventListener("click",n=>{H(n.target.id)}),document.getElementById(`${a}_global`).innerHTML=`${a}<span style="float:right; color: yellow;">&#9679;</span>`,document.getElementById("inSceneChars").appendChild(p),l.classList.add("sceneElement"),l.setAttribute("id",`char_${a}`),y.setAttribute("src",((d=v.SUD.Characters.find(({name:n})=>n===r))==null?void 0:d.images.default)||I.persona.images.default),l.appendChild(y),l.style.height=I.pns.height,l.style.width=I.pns.width,l.style.left=I.pns.left,l.style.right=I.pns.right,l.style.top=I.pns.top,l.style.position=I.pns.position,l.style.zIndex=I.pns.zIndex,l.style.position="absolute",l.style.opacity="1",y.style.width="auto",y.style.height="100%",y.style.objectFit="contain",document.querySelector(".currentScene").appendChild(l),e==null||e.characters.push(I)}c=`char_${a}`,document.getElementById(`char_${a}`).style.border="1px solid yellow",setTimeout(()=>{document.getElementById(`char_${a}`).style.border="none"},1e3);for(const n in e.characters)if(e.characters[n].persona.name===a){document.getElementById("chElAtt").innerHTML=`
        ...
        `,document.querySelector("#editorUserInput").innerHTML="",e.elements[d].shadow===!0&&(document.querySelector("#charAttActionInput").checked=!0),document.querySelectorAll(".sliderAttValue").forEach(A=>{A.innerHTML==="auto"&&(document.getElementById(A.id.replace("Value","Slider")).value=101,document.querySelector(`#${A.id.replace("Value","Slider")}`).style.pointerEvents="none"),A.innerHTML===""&&(document.getElementById(A.id.replace("Value","Slider")).value=-101,document.getElementById(A.id).innerHTML="-")});var h=document.getElementById(`${e.elements[d].id}-cont`);h.style.left=document.getElementById("leftValue").innerHTML,h.style.right=document.getElementById("rightValue").innerHTML+"%",h.style.bottom=document.getElementById("bottomValue").innerHTML+"%",h.style.top=document.getElementById("topValue").innerHTML+"%",h.style.zIndex=document.getElementById("zIndexValue").innerHTML,h.style.width=document.getElementById("widthValue").innerHTML+"%",h.style.height=document.getElementById("heightValue").innerHTML,document.querySelector(`#${e.elements[d].id}-cont img:first-child`).style.filter=`blur(${document.getElementById("blurValue").innerHTML}) brightness(${document.getElementById("brightnessValue").innerHTML})`;var g=!1;document.querySelector("#attLock").addEventListener("click",()=>{if(g===!1){g=!0,document.querySelector("#attLock").innerHTML="🔒";return}else{e.elements[d].locked=!1,document.querySelector("#attLock").innerHTML="🔓",g=!1;return}}),document.querySelectorAll(".slider").forEach(A=>{var $=v.SUD.Scenarios[f].find(({name:m})=>m===e.name).elements.find(({id:m})=>m===c.replace("-cont",""));A.addEventListener("input",m=>{document.querySelector(`#${m.target.id.replace("Slider","Value")}`).innerHTML=m.target.value,document.getElementById("updateScopeSelect").value==="scene"&&($[m.target.id.replace("Slider","")]=m.target.value),m.target.value==="101"&&(document.querySelector(`#${m.target.id.replace("Slider","Value")}`).innerHTML="auto",document.getElementById("updateScopeSelect").value==="scene"&&($[m.target.id.replace("Slider","")]=m.target.value)),m.target.value==="-101"&&(document.querySelector(`#${m.target.id.replace("Slider","Value")}`).innerHTML="",document.getElementById("updateScopeSelect").value==="scene"&&($[m.target.id.replace("Slider","")]=m.target.value)),`${m.target.value}%`!=e.elements[d][m.target.id.replace("Slider","")]&&m.target.getAttribute("data-valueType")==="%"?(document.querySelector(`#${m.target.id.replace("Slider","Value")}`).style.color="yellow",document.getElementById("updateScopeSelect").value==="scene"&&($[m.target.id.replace("Slider","")]=m.target.value)):`${m.target.value}px`!=e.elements[d][m.target.id.replace("Slider","")]&&m.target.getAttribute("data-valueType")==="px"?(document.querySelector(`#${m.target.id.replace("Slider","Value")}`).style.color="yellow",document.getElementById("updateScopeSelect").value==="scene"&&($[m.target.id.replace("Slider","")]=m.target.value)):Number(m.target.value)!=e.elements[d][m.target.id.replace("Slider","")]&&m.target.getAttribute("data-valueType")==="#%"?(document.querySelector(`#${m.target.id.replace("Slider","Value")}`).style.color="yellow",document.getElementById("updateScopeSelect").value==="scene"&&($[m.target.id.replace("Slider","")]=m.target.value)):m.target.value!=e.elements[d][m.target.id.replace("Slider","")]&&m.target.getAttribute("data-valueType")==="##"?(document.querySelector(`#${m.target.id.replace("Slider","Value")}`).style.color="yellow",document.getElementById("updateScopeSelect").value==="scene"&&($[m.target.id.replace("Slider","")]=m.target.value)):(console.log("not changed"),document.querySelector(`#${m.target.id.replace("Slider","Value")}`).style.color="#ff002d",document.getElementById("updateScopeSelect").value==="scene"&&($[m.target.id.replace("Slider","")]=m.target.value));var n=document.getElementById(`${c}`);n.style.left=document.getElementById("leftValue").innerHTML+"%",n.style.right=document.getElementById("rightValue").innerHTML+"%",n.style.bottom=document.getElementById("bottomValue").innerHTML+"%",n.style.top=document.getElementById("topValue").innerHTML+"%",n.style.zIndex=document.getElementById("zIndexValue").innerHTML,n.style.width=document.getElementById("widthValue").innerHTML+"%",n.style.height=document.getElementById("heightValue").innerHTML+"%",document.querySelector(`#${e.elements[d].id}-cont img:first-child`).style.filter=`blur(${document.getElementById("blurValue").innerHTML}px) brightness(${document.getElementById("brightnessValue").innerHTML})`,g===!0&&(document.getElementById("leftToSlider").value=document.getElementById("leftSlider").value,document.getElementById("leftToValue").innerHTML=document.getElementById("leftSlider").value,document.getElementById("rightToSlider").value=document.getElementById("rightSlider").value,document.getElementById("rightToValue").innerHTML=document.getElementById("rightSlider").value,document.getElementById("bottomToSlider").value=document.getElementById("bottomSlider").value,document.getElementById("bottomToValue").innerHTML=document.getElementById("bottomSlider").value,document.getElementById("topToSlider").value=document.getElementById("topSlider").value,document.getElementById("topToValue").innerHTML=document.getElementById("topSlider").value,document.getElementById("zIndexToSlider").value=document.getElementById("zIndexSlider").value,document.getElementById("zIndexToValue").innerHTML=document.getElementById("zIndexSlider").value,document.getElementById("widthToSlider").value=document.getElementById("widthSlider").value,document.getElementById("widthToValue").innerHTML=document.getElementById("widthSlider").value,document.getElementById("heightToSlider").value=document.getElementById("heightSlider").value,document.getElementById("heightToValue").innerHTML=document.getElementById("heightSlider").value,document.getElementById("blurToSlider").value=document.getElementById("blurSlider").value,document.getElementById("blurToValue").innerHTML=document.getElementById("blurSlider").value,document.getElementById("brightnessToSlider").value=document.getElementById("brightnessSlider").value,document.getElementById("brightnessToValue").innerHTML=document.getElementById("brightnessSlider").value)})})}},K=a=>{c=`${a}`,document.getElementById(c).style.color="yellow",setTimeout(()=>{document.getElementById(c).style.color="#ff002d"},1e3);for(const o in e.characters)if("element"in e.characters[o]){document.getElementById("chElAtt").innerHTML=`
            ...
            `,document.querySelector("#charAttTalkInput").addEventListener("change",i=>{i.target.value==="left"?(document.getElementById(`${c.replace("dialogue","")}pointer`).style.right="",document.getElementById(`${c.replace("dialogue","")}pointer`).style.left="-30px",document.getElementById(`${c.replace("dialogue","")}pointer`).style.borderLeft="1px solid #ff002d",document.getElementById(`${c.replace("dialogue","")}pointer`).style.borderTop="0px solid #ff002d"):(document.getElementById(`${c.replace("dialogue","")}pointer`).style.right="-30px",document.getElementById(`${c.replace("dialogue","")}pointer`).style.left="",document.getElementById(`${c.replace("dialogue","")}pointer`).style.borderLeft="0px solid #ff002d",document.getElementById(`${c.replace("dialogue","")}pointer`).style.borderTop="1px solid #ff002d")}),document.querySelector("#editorUserInput").innerHTML="",document.querySelectorAll(".sliderAttValue").forEach(i=>{i.innerHTML==="auto"&&(document.getElementById(i.id.replace("Value","Slider")).value=101,document.querySelector(`#${i.id.replace("Value","Slider")}`).style.pointerEvents="none"),i.innerHTML===""&&(document.getElementById(i.id.replace("Value","Slider")).value=-101,document.getElementById(i.id).innerHTML="-")});var r=document.getElementById(`${e.characters[o].persona.name}_dialogue`);r.style.left=document.getElementById("leftValue").innerHTML,r.style.right=document.getElementById("rightValue").innerHTML+"%",r.style.bottom=document.getElementById("bottomValue").innerHTML+"%",r.style.top=document.getElementById("topValue").innerHTML+"%",r.style.zIndex=document.getElementById("zIndexValue").innerHTML,r.style.width=document.getElementById("widthValue").innerHTML+"px",r.style.height=document.getElementById("heightValue").innerHTML,document.querySelectorAll(".slider").forEach(i=>{var s=v.SUD.Scenarios[f].find(({name:t})=>t===e.name).characters.find(({persona:t})=>t.name===c.replace("_dialogue",""));i.addEventListener("input",t=>{document.querySelector(`#${t.target.id.replace("Slider","Value")}`).innerHTML=t.target.value,t.target.value==="101"&&(document.querySelector(`#${t.target.id.replace("Slider","Value")}`).innerHTML="auto"),t.target.value==="-101"&&(document.querySelector(`#${t.target.id.replace("Slider","Value")}`).innerHTML=""),`${t.target.value}%`!=e.elements[o][t.target.id.replace("Slider","")]&&t.target.getAttribute("data-valueType")==="%"?document.querySelector(`#${t.target.id.replace("Slider","Value")}`).style.color="yellow":`${t.target.value}px`!=e.elements[o][t.target.id.replace("Slider","")]&&t.target.getAttribute("data-valueType")==="px"?document.querySelector(`#${t.target.id.replace("Slider","Value")}`).style.color="yellow":Number(t.target.value)!=e.elements[o][t.target.id.replace("Slider","")]&&t.target.getAttribute("data-valueType")==="#%"?document.querySelector(`#${t.target.id.replace("Slider","Value")}`).style.color="yellow":t.target.value!=e.elements[o][t.target.id.replace("Slider","")]&&t.target.getAttribute("data-valueType")==="##"?(document.querySelector(`#${t.target.id.replace("Slider","Value")}`).style.color="yellow",document.getElementById("updateScopeSelect").value==="scene"&&(s.element[t.target.id.replace("Slider","")]=t.target.value)):(console.log("not changed"),document.querySelector(`#${t.target.id.replace("Slider","Value")}`).style.color="#ff002d",document.getElementById("updateScopeSelect").value==="scene"&&(s.element[t.target.id.replace("Slider","")]=t.target.value));var l=document.getElementById(`${e.characters[o].persona.name}_dialogue`),y=document.getElementById("leftValue").innerHTML,p=document.getElementById("rightValue").innerHTML,h=document.getElementById("bottomValue").innerHTML,g=document.getElementById("topValue").innerHTML,T=document.getElementById("zIndexValue").innerHTML,L=document.getElementById("widthValue").innerHTML,M=document.getElementById("heightValue").innerHTML;l.setAttribute("style",`left: ${y} !important; right: ${p}% !important; bottom: ${h}% !important; top: ${g}% !important; z-index: ${T} !important; width: ${L}px !important; height: ${M}px !important;inset: -5% -10% auto auto; z-index: 2; border-radius: 10px; border-top: 0.5px solid rgb(255, 0, 45); border-bottom: 0.5px solid rgb(255, 0, 45); padding: 10px; transform: translate(0px, 0px); transform-origin: left bottom; translate: none; rotate: none; scale: none;`)})})}};var k=()=>{const a=JSON.stringify(v);fetch("http://localhost:3001/save-json",{method:"POST",body:a,headers:{"Content-Type":"application/json"}}).then(r=>{r.ok?console.log("JSON data saved successfully"):console.error("Error saving JSON data")}).catch(r=>{console.error("Error saving JSON data:",r)})};document.querySelector("#generateScenario").addEventListener("click",a=>{a.preventDefault();var r=document.getElementById("scenarioEdit");r.value!=""&&(v.SUD.Scenarios[r.value]=[],console.log("tempData",v),k())});var j=()=>{document.querySelector("#newSceneBut").addEventListener("click",()=>{var o;v=U,F=ee,C=0,w=0,v.SUD.Scenarios[f].push(F),e=v.SUD.Scenarios[f].find(({name:i})=>i==="newScene");var a=document.createElement("div"),r=document.getElementById("editorbodyDisplay");a.setAttribute("clas s","currentScene"),a.setAttribute("id","currentSceneView_draft"),a.setAttribute("style","z-index: 10; position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.75); opacity: 1;"),r.appendChild(a),document.getElementById("inSceneChars").innerHTML="",document.getElementById("inSceneEls").innerHTML="",document.getElementById("inSceneCharsDialogues").innerHTML="",document.getElementById("headerSceneName").innerHTML="[ NEW SCENE ]",document.getElementById("headerSceneName").setAttribute("class","pendingSaveText"),(o=document.querySelector(".currentScene"))==null||o.remove(),document.getElementById("scnAttName").value="[ NEW SCENE ]",document.getElementById("scnAttName").setAttribute("class","attInput pendingSaveText"),document.querySelectorAll(".sceneSelectElementEl").forEach(i=>{i.innerHTML=`${i.id.replace("_global","")}`;var s=()=>{var t=document.createElement("div");t.setAttribute("class","inSceneCard pendingSaveCard"),t.setAttribute("id","newElementUnsaved"),t.innerHTML=`${i.id.replace("_global","")}`,i.removeEventListener("click",s),i.innerHTML=`${i.id.replace("_global","")}<span style="float:right; color: yellow">&#9679;</span>`};if(!i.getAttribute("data-listener")){i.addEventListener("click",s);return}i.removeAttribute("data-listener")}),document.querySelectorAll(".sceneSelectElementChar").forEach(i=>{i.innerHTML=`${i.id.replace("_global","")}`;var s=()=>{var t=document.createElement("div");t.setAttribute("class","inSceneCard pendingSaveCard"),t.setAttribute("id","newElementUnsaved"),t.innerHTML=`${i.id.replace("_global","")}`,i.removeEventListener("click",s),i.innerHTML=`${i.id.replace("_global","")}<span style="float:right; color: yellow">&#9679;</span>`};i.getAttribute("data-listener")||i.addEventListener("click",s),i.removeAttribute("data-listener")}),document.querySelectorAll(".sceneSelectElement").forEach(i=>{i.id==="newSceneBut"?i.innerHTML=`${i.id}<span style="float:right; color: yellow">&#9679;</span>`:i.innerHTML=`${i.id.replace("_global","")}`})}),document.getElementById("addToScope").addEventListener("click",()=>{var a=document.getElementById("editorUserInput").value;if(e.activated.land=document.getElementById("scnAttAct1").value,e.activated.pop=document.getElementById("scnAttAct2").value,e.activated.gate=document.getElementById("scnAttAct3").value,e.activated.scn=document.getElementById("scnAttAct4").value,R==="charAttDialogue"){var r=e.characters.find(({persona:t})=>t.name===c.replace("char_","")),o=document.createElement("option");o.setAttribute("value",a),o.innerHTML=a,document.getElementById("charAttTalkInput").appendChild(o),r.persona.name=document.getElementById("charAttNameInput").value,r.persona.location=document.getElementById("charAttLocInput").value,r.persona.job=document.getElementById("charAttJobInput").value}if(R==="charAttImages"){var i=document.createElement("option");i.setAttribute("value",a),i.innerHTML=a,document.getElementById("charAttImgInput").appendChild(i)}if(R==="charAttSource"){var s=e.elements.find(({id:t})=>t===c);document.getElementById("charAttImgInput").value=a,document.getElementById(`${c.replace("cont","src")}`).src=a,s.id=document.getElementById("charAttNameInput").value,s.action=document.getElementById("charAttJobInput").value,s.src=document.getElementById("charAttImgInput").value}document.getElementById("editorUserInput").value=""}),document.querySelector("#newCharBut").addEventListener("click",()=>{C++;var a=document.createElement("div");a.setAttribute("class","inSceneCard pendingSaveCard"),a.setAttribute("id",`newCharacterUnsaved-${C}`),a.innerHTML="[ NEW CHAR ]",a.addEventListener("click",r=>{H(r.target.id)}),document.getElementById("inSceneChars").appendChild(a)}),document.querySelector("#newElBut").addEventListener("click",()=>{w++;var a=document.createElement("div");a.setAttribute("class","inSceneCard pendingSaveCard"),a.setAttribute("id",`newElementUnsaved-${w}`),a.innerHTML="[ NEW EL ]",a.addEventListener("click",r=>{z(r.target.id)}),document.getElementById("inSceneEls").appendChild(a)})};return j(),document.querySelector("#deleteScenario").addEventListener("click",a=>{a.preventDefault();var r=document.getElementById("scenarioEdit");r.value!=""&&v.SUD.Scenarios[r.value]&&(delete v.SUD.Scenarios[r.value],console.log("tempData",v),k())}),document.getElementById("deleteEl").addEventListener("click",()=>{var a=document.createElement("div");a.setAttribute("id","warningBG"),a.setAttribute("class","warningBG"),a.innerHTML=`
      <div id="warningBlock">
      ...
      `,document.getElementById("editorScreen").appendChild(a),document.getElementById("warningBGNo").addEventListener("click",()=>{document.getElementById("warningBG").remove()}),document.getElementById("warningBGYes").addEventListener("click",()=>{var i,s,t,l,y;var r=document.getElementById("updateScopeSelect").value;switch(r){case"scene":delete v.SUD.Scenarios[f].find(({name:p})=>p===e.name),k();break;case"select":var o=(i=document.getElementById(`${c.replace("char_","")}`))==null?void 0:i.innerHTML;c.includes("-cont")&&(delete v.SUD.Scenarios[f].find(({name:p})=>p===e.name).elements.find(({id:p})=>p===c),(s=document.getElementById(c.replace("-cont","")))==null||s.remove(),document.getElementById(`${c.replace("-cont","")}_global`)&&(document.getElementById(`${c.replace("-cont","")}_global`).innerHTML=`${c.replace("-cont","")}`)),c.includes("char_")&&(delete v.SUD.Scenarios[f].find(({name:p})=>p===e.name).characters.find(({persona:p})=>p.name===c),(t=document.getElementById(c.replace("char_","")))==null||t.remove(),(l=document.getElementById(`${c.replace("char_","")}-dia`))==null||l.remove(),document.getElementById(`${c.replace("char_","")}_global`)&&(document.getElementById(`${c.replace("char_","")}_global`).innerHTML=`${c.replace("char_","")}`)),c.includes("newCharacterUnsaved")&&(document.getElementById(`${o}_global`).innerHTML=`${o}`,document.getElementById(`${o}_global`).addEventListener("click",p=>{H(p.target.id.replace("_global",""),o)})),(y=document.getElementById(c))==null||y.remove();break;case"isolated":if(c.includes("-cont")){for(const p in v.SUD.Scenarios)for(const h in v.SUD.Scenarios[f])h.elements.find(({id:g})=>g===c.id)&&delete v.SUD.Scenarios[p][h].elements.find(({id:g})=>g===c);delete v.SUD.Elements.find(({id:p})=>p===c.id)}if(c.includes("char_")){for(const p in v.SUD.Scenarios)for(const h in v.SUD.Scenarios[f])h.characters.find(({persona:g})=>g.name===c)&&delete v.SUD.Scenarios[p][h].characters.find(({persona:g})=>g.name===c.persona.name);delete v.SUD.Characters.find(({persona:p})=>p.name===c.persona.name)}k();break}})}),document.getElementById("saveScene").addEventListener("click",()=>{var a=document.createElement("div");a.setAttribute("id","warningBG"),a.setAttribute("class","warningBG"),a.innerHTML=`
      <div id="warningBlock">
      ...
      `,document.getElementById("editorScreen").appendChild(a),document.getElementById("warningBGNo").addEventListener("click",()=>{document.getElementById("warningBG").remove()}),document.getElementById("warningBGYes").addEventListener("click",()=>{var r=document.getElementById("updateScopeSelect").value;switch(r){case"scene":break;case"isolated":if(c.includes("-cont")){var o={id:`${S.id}`,src:`${S.src}`};v.SUD.Elements.push(o)}c.includes("char_")&&v.SUD.Characters.push(I.persona);break}k()})}),document.getElementById("scenesContainer").appendChild(document.getElementById("newSceneBut")),document.getElementById("editorScreen").style.display="block",document.getElementById("mapperBut").addEventListener("click",()=>{Z()}),document.querySelector(".currentScene")?(J=document.getElementById("editorbodyDisplay"))==null||J.appendChild(document.querySelector(".currentScene")):(document.getElementById("universe").style.filter="blur(10px)",setTimeout(()=>{var a;(a=document.getElementById("editorbodyDisplay"))==null||a.appendChild(document.querySelector(".currentScene"))},1e3)),!0}else return document.getElementById("editorScreen").remove(),document.getElementById("universe").style.filter="blur(0px)",!1}export{ne as editor};
