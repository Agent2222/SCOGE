import{b as K,n as Q,g as Z}from"./index.cebb7aa5.js";function ee(){var W=document.getElementById("mapperBut");document.getElementById("camera");var M=document.querySelectorAll(".uniEvents"),N=document.getElementById("getUniMenu"),x=document.getElementById("powerUp1"),w=document.getElementById("ringView");if(window.mapperActive==!0){W.style.color="var(--primary)",M.forEach($=>{$.style.display="block"}),N.style.opacity="1",N.style.pointerEvents="auto",x.style.display="block",w.style.display="block",window.mapperActive=!1;return}else W.style.color="var(--accent)",M.forEach($=>{$.style.display="none"}),N.style.opacity="0",N.style.pointerEvents="none",x.style.display="none",w.style.display="none",window.mapperActive=!0}const te="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",ae=new K.Configuration({apiKey:te}),ne=new K.OpenAIApi(ae);var R=null,v=null,T=null,B=null,e=null,c=null,D=0,U=0,j=!1,J=null,le={name:"newScene",position:0,type:"dialogue",bg:"rgba(0,0,0,0.75)",activated:{land:0,pop:!1,gate:0,scn:[]},characters:[],elements:[]},O={name:"newScene",position:0,type:"dialogue",bg:"rgba(0,0,0,0.75)",activated:{land:0,pop:!1,gate:0,scn:[]},characters:[],elements:[]},S={id:"newElement",type:"div",src:"https://storage.fleek-internal.com/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Universe/Elements/charTemplate.png",left:"auto",right:"10%",bottom:"auto",top:"5%",zIndex:"3",width:"auto",height:"30%",speed:.9,shadow:!0,shadowEffect:"0px",brightness:"1.0",leftTo:"",rightTo:"",bottomTo:"",topTo:"",zIndexTo:"",widthTo:"",heightTo:"",shadowEffectTo:"",brightnessTo:"",action:""},I={persona:{name:"newCharacter",location:"newLocation",job:"newJob",dialogue:{intro:"Hello, I will become a new character."},images:{default:"https://storage.fleek-internal.com/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Universe/Characters/char-template.png"}},pns:{position:"absolute",left:"10%",leftTo:"12%",right:"auto",rightTo:"auto",bottom:0,bottomTo:0,top:"auto",topTo:"auto",zIndex:1,zIndexTo:1,width:"auto",widthTo:"auto",height:"80%",heightTo:"80%",speed:1,blur:"0px",blurTo:"0px",brightness:"1",brightnessTo:"1"},element:{class:"chr-textElement",type:"div",backgroundColor:"rgba(0,0,0,0.75)",padding:"10px 10px",borderRadius:"10px",borderTop:"0.5px solid rgb(255, 0, 45)",borderBottom:"0.5px solid rgb(255, 0, 45)",width:"350px",height:"auto",left:"auto",right:"-10%",bottom:"auto",top:"-6%",zIndex:2,position:"absolute",border:".5px solid #ff002d",pointer:{position:"absolute",width:"50px",height:"50px",borderLeft:"1px solid #ff002d",bottom:"-60px",left:"-30px",zIndex:-5,transform:"rotate(45deg)"}},actions:["chat"]};async function ie(W){var Y;try{const L=await fetch("/src/sudb.json");if(!L.ok)throw new Error(`HTTP error! Status: ${L.status}`);R=await L.json(),v=R,T=R.SUD.Scenarios.Intro}catch(L){console.error("Error fetching JSON data:",L)}if(W===!1){const L=document.createElement("link");L.rel="stylesheet",L.href="editor.css",document.head.appendChild(L);var M=document.createElement("div"),N=document.getElementById("main");M.setAttribute("id","editorScreen"),M.innerHTML=`
            <div id="editorHeader">
        ...
        `,N.appendChild(M),document.getElementById("loadScene").addEventListener("click",()=>{document.getElementById("editorbodyDisplay").appendChild(document.querySelector(".currentScene"))}),document.getElementById("aiAsstSelectScope").addEventListener("change",()=>{J=document.getElementById("aiAsstSelectScope").value});var x=document.getElementById("scenarioDropdown");for(const a in v.SUD.Scenarios){var w=document.createElement("option");w.setAttribute("value",a),w.innerHTML=a,x.appendChild(w)}B=x.value,x.addEventListener("change",()=>{var o,t;var a=v.SUD.Scenarios[x.value];T=v.SUD.Scenarios[x.value],document.getElementById("scenesContainer").innerHTML="",a.forEach(d=>{var n=document.createElement("div");n.setAttribute("class","sceneSelectElement"),n.setAttribute("id",d.name),n.innerHTML=`${d.name}`,n.addEventListener("click",m=>{P(m.target.id)}),document.getElementById("scenesContainer").appendChild(n)});var r=document.createElement("div");r.setAttribute("class","sceneSelectElement"),r.setAttribute("id","newSceneBut"),r.innerHTML="[ NEW SCENE ]",document.getElementById("scenesContainer").appendChild(r),F(),j&&((o=document.querySelector(".currentScene"))==null||o.remove(),P((t=a[0])==null?void 0:t.name,0))}),T.forEach(a=>{v=R;var r=document.createElement("div");r.setAttribute("class","sceneSelectElement"),r.setAttribute("data-position",a.position-1),r.setAttribute("id",a.name),r.innerHTML=`${a.name}`,a.name==="scene1"?r.innerHTML=`${a.name}<span style="float:right; color: var(--accent)">&#9679;</span>`:r.innerHTML=`${a.name}`,r.addEventListener("click",o=>{var d;if(e.elements.find(({id:n})=>n.includes("newElementUnsaved"))&&(e.elements=e.elements.filter(({id:n})=>!n.includes("newElementUnsaved"))),e.characters.find(({persona:n})=>n.name.includes("newCharacterUnsaved"))&&(e.characters=e.characters.filter(({persona:n})=>!n.name.includes("newCharacterUnsaved"))),j){var t=o.target.getAttribute("data-position");(d=document.querySelectorAll(".currentScene")[0])==null||d.remove(),P(o.target.id,t)}document.getElementById("headerSceneName").style.color="yellow",setTimeout(()=>{document.getElementById("headerSceneName").style.color="#ff002d"},1e3)}),document.getElementById("scenesContainer").appendChild(r)});const P=(a,r)=>{var o;D=0,U=0,document.querySelector(".currentScene")===null&&(Q(`${B}`,r),setTimeout(()=>{var t;(t=document.getElementById("editorbodyDisplay"))==null||t.appendChild(document.querySelector(".currentScene"))},1e3)),document.querySelectorAll(".sceneSelectElement").forEach(t=>{document.getElementById("scnAttName").setAttribute("class","attInput"),document.getElementById("headerSceneName").removeAttribute("class"),t.id===a?document.getElementById(a).innerHTML=`${a}<span style="float:right; color: var(--accent)">&#9679;</span>`:document.getElementById(t.id).innerHTML=`${t.id}`});for(const t in T)T[t].name===a&&(e=T[t],document.getElementById("hsc").innerHTML=`${T[t].activated}]`,document.getElementById("headerSceneName").innerHTML=`${T[t].name}`,document.getElementById("scnAttName").value=`${T[t].name}`,document.getElementById("scnAttType").value=`${T[t].type}`,document.getElementById("scnAttBg").value=`${T[t].bg}`,document.getElementById("scnAttAct1").value=`${T[t].activated.land}`,document.getElementById("scnAttAct2").value=`${T[t].activated.pop}`,T[t].activated.pop===!0?document.getElementById("scnAttAct2").selectedIndex=0:document.getElementById("scnAttAct2").selectedIndex=1,document.getElementById("scnAttAct3").value=`${T[t].activated.gate}`,document.getElementById("scnAttAct4").value=`${parseInt((o=T[t].activated.scn)==null?void 0:o.join(""))}`,document.getElementById("inSceneChars").innerHTML="",document.getElementById("inSceneEls").innerHTML="",T[t].characters.forEach(d=>{var n=document.createElement("div");if(n.setAttribute("class","inSceneCard"),n.setAttribute("id",d.persona.name),n.innerHTML=`${d.persona.name}`,document.getElementById("inSceneChars").appendChild(n),"element"in d){var m=document.createElement("div");m.setAttribute("class","inSceneCard"),m.setAttribute("id",`${d.persona.name}-dia`),m.innerHTML=`${d.persona.name} - ${d.actions[0]}`,document.getElementById("inSceneCharsDialogues").innerHTML="",document.getElementById("inSceneCharsDialogues").appendChild(m),m.addEventListener("click",g=>{X(g.target.id),d.persona.dialogue.pPosition==="left"?document.getElementById("charAttTalkInput").value="left":document.getElementById("charAttTalkInput").value="right"})}n.addEventListener("click",g=>{C(g.target.id)})}),T[t].elements.forEach(d=>{var n=document.createElement("div");n.setAttribute("class","inSceneCard"),n.setAttribute("id",d.id),n.innerHTML=`${d.id}`,document.getElementById("inSceneEls").appendChild(n),n.addEventListener("click",m=>{_(m.target.id)})}));j===!0&&document.querySelectorAll(".sceneSelectElementChar").forEach(t=>{t.remove()}),j===!0&&document.querySelectorAll(".sceneSelectElementEl").forEach(t=>{t.remove()}),v.SUD.Characters.forEach(t=>{var d=document.createElement("div"),n=document.getElementById("newCharBut");n.innerHTML="[ NEW CHARACTER ]",d.setAttribute("class","sceneSelectElementChar"),d.setAttribute("id",`${t.name}_global`);var m=e.characters.find(({persona:s})=>s.name===t.name);if(m)d.innerHTML=`${t.name}<span style="float:right; color: var(--accent)">&#9679;</span>`,d.addEventListener("click",s=>{C(s.target.id.replace("_global",""),t.name)});else{d.innerHTML=`${t.name}`;var g=()=>{D++;var s=document.createElement("div");s.setAttribute("class","inSceneCard pendingSaveCard"),s.setAttribute("id",`newCharacterUnsaved-${D}`),s.innerHTML=`${t.name}`,document.getElementById("inSceneChars").appendChild(s),s.addEventListener("click",h=>{C(h.target.id.replace("_global",""),t.name)}),d.removeEventListener("click",g),d.innerHTML=`${t.name}<span style="float:right; color: yellow">&#9679;</span>`};d.addEventListener("click",g),d.setAttribute("data-listener","true")}document.getElementById("charactersContainer").appendChild(d),document.getElementById("charactersContainer").appendChild(n)}),v.SUD.Elements.forEach(t=>{var d=document.createElement("div"),n=document.getElementById("newElBut");n.innerHTML="[ NEW ELEMENT ]",d.setAttribute("class","sceneSelectElementEl"),d.setAttribute("id",`${t.id}_global`);var m=e.elements.find(({id:s})=>s===t.id);if(m)d.innerHTML=`${t.id}<span style="float:right; color: var(--accent)">&#9679;</span>`,d.addEventListener("click",s=>{_(s.target.id.replace("_global",""))});else{d.innerHTML=`${t.id}`;var g=()=>{U++;var s=document.createElement("div");s.setAttribute("class","inSceneCard pendingSaveCard"),s.setAttribute("id",`"newElementUnsaved"-${U}`),s.innerHTML=`${t.id}}`,document.getElementById("inSceneEls").appendChild(s),s.addEventListener("click",h=>{_(h.target.id.replace("_global",""),t.id)}),d.removeEventListener("click",g),d.innerHTML=`${t.id}<span style="float:right; color: var(--accent)">&#9679;</span>`};d.addEventListener("click",g),d.setAttribute("data-listener","true")}document.getElementById("elsContainer").appendChild(d),document.getElementById("elsContainer").appendChild(n)}),j=!0};P("scene1",0),document.getElementById("summonAI").addEventListener("click",async()=>{document.getElementById("editorAiOutput").innerHTML="Loading...";var a=document.getElementById("editorUserInput").value,r=await ne.createChatCompletion({model:"gpt-3.5-turbo",messages:[{role:"user",content:`Hello. ${a}`}],max_tokens:100}).catch(o=>{console.log(o)});console.log(r),document.getElementById("editorUserInput").value="",document.getElementById("editorAiOutput").innerHTML=`${r.data.choices[0].message.content}`});const C=(a,r)=>{var G,i,f,A,p;var o=document.querySelector(".currentScene"),t=Array.from(o.childNodes);if(!t.find(l=>l.id.includes(`${`char_${a}`}`)))if(a.includes("newCharacterUnsaved-")){I.persona.name=a;var d=document.createElement("div"),n=document.createElement("img");d.classList.add("sceneElement"),d.setAttribute("id",`char_${a}`),n.setAttribute("src",((G=v.SUD.Characters.find(({name:l})=>l===r))==null?void 0:G.images.default)||I.persona.images.default),d.appendChild(n),d.style.height=I.pns.height,d.style.width=I.pns.width,d.style.left=I.pns.left,d.style.right=I.pns.right,d.style.top=I.pns.top,d.style.position=I.pns.position,d.style.zIndex=I.pns.zIndex,d.style.position="absolute",d.style.opacity="1",n.style.width="auto",n.style.height="100%",n.style.objectFit="contain",document.querySelector(".currentScene").appendChild(d),e==null||e.characters.push(I)}else{I.persona.name=a;var m=document.createElement("div"),g=document.createElement("img"),s=document.createElement("div");s.setAttribute("class","inSceneCard pendingSaveCard"),s.setAttribute("id",`${a}`),s.innerHTML=`${a}`,s.addEventListener("click",l=>{C(l.target.id)}),document.getElementById(`${a}_global`).innerHTML=`${a}<span style="float:right; color: yellow;">&#9679;</span>`,document.getElementById("inSceneChars").appendChild(s),m.classList.add("sceneElement"),m.setAttribute("id",`char_${a}`),g.setAttribute("src",((i=v.SUD.Characters.find(({name:l})=>l===r))==null?void 0:i.images.default)||I.persona.images.default),m.appendChild(g),m.style.height=I.pns.height,m.style.width=I.pns.width,m.style.left=I.pns.left,m.style.right=I.pns.right,m.style.top=I.pns.top,m.style.position=I.pns.position,m.style.zIndex=I.pns.zIndex,m.style.position="absolute",m.style.opacity="1",g.style.width="auto",g.style.height="100%",g.style.objectFit="contain",document.querySelector(".currentScene").appendChild(m),e==null||e.characters.push(I)}c=`char_${a}`,document.getElementById(`char_${a}`).style.border="1px solid yellow",setTimeout(()=>{document.getElementById(`char_${a}`).style.border="none"},1e3);for(const l in e.characters)if(e.characters[l].persona.name===a){document.getElementById("chElAtt").innerHTML=`
            ...
            <div class="sliderAttribute">
                ...
                <input type="range" min="-101" max="101" value="${Number((q=e.elements[i].topTo)==null?void 0:q.replace("%",""))}" class="slider" id="topToSlider" data-valueType="%">
            </div>
            <div class="sliderAttribute">
                <div>zIndex To:</div>
            ...
            <div class="sliderAttribute">
                ...
                <input type="range" min="0" max="200" value="${Number((z=e.elements[i].heightTo)==null?void 0:z.replace("%",""))}" class="slider" id="heightToSlider" data-valueType="%">
            </div>
            <div class="sliderAttribute">
                <div>Blur To:</div>
                <span class="sliderAttValue" id="blurToValue">${e.elements[i].shadowEffectTo}</span>
                <input type="range" min="0" max="100" value="${Number((G=e.elements[i].shadowEffectTo)==null?void 0:G.replace("px",""))}" class="slider" id="blurToSlider" data-valueType="px">
            </div>
            <div class="sliderAttribute">
                <div>Bright To:</div>
      ...
      `,document.getElementById("editorScreen").appendChild(a),document.getElementById("warningBGNo").addEventListener("click",()=>{document.getElementById("warningBG").remove()}),document.getElementById("warningBGYes").addEventListener("click",()=>{var t,d,n,m,g;var r=document.getElementById("updateScopeSelect").value;switch(r){case"scene":delete v.SUD.Scenarios[B].find(({name:s})=>s===e.name),$();break;case"select":var o=(t=document.getElementById(`${c.replace("char_","")}`))==null?void 0:t.innerHTML;c.includes("-cont")&&(delete v.SUD.Scenarios[B].find(({name:s})=>s===e.name).elements.find(({id:s})=>s===c),(d=document.getElementById(c.replace("-cont","")))==null||d.remove(),document.getElementById(`${c.replace("-cont","")}_global`)&&(document.getElementById(`${c.replace("-cont","")}_global`).innerHTML=`${c.replace("-cont","")}`)),c.includes("char_")&&(delete v.SUD.Scenarios[B].find(({name:s})=>s===e.name).characters.find(({persona:s})=>s.name===c),(n=document.getElementById(c.replace("char_","")))==null||n.remove(),(m=document.getElementById(`${c.replace("char_","")}-dia`))==null||m.remove(),document.getElementById(`${c.replace("char_","")}_global`)&&(document.getElementById(`${c.replace("char_","")}_global`).innerHTML=`${c.replace("char_","")}`)),c.includes("newCharacterUnsaved")&&(document.getElementById(`${o}_global`).innerHTML=`${o}`,document.getElementById(`${o}_global`).addEventListener("click",s=>{C(s.target.id.replace("_global",""),o)})),(g=document.getElementById(c))==null||g.remove();break;case"isolated":if(c.includes("-cont")){for(const s in v.SUD.Scenarios)for(const h in v.SUD.Scenarios[B])h.elements.find(({id:b})=>b===c.id)&&delete v.SUD.Scenarios[s][h].elements.find(({id:b})=>b===c);delete v.SUD.Elements.find(({id:s})=>s===c.id)}if(c.includes("char_")){for(const s in v.SUD.Scenarios)for(const h in v.SUD.Scenarios[B])h.characters.find(({persona:b})=>b.name===c)&&delete v.SUD.Scenarios[s][h].characters.find(({persona:b})=>b.name===c.persona.name);delete v.SUD.Characters.find(({persona:s})=>s.name===c.persona.name)}$();break}})}),document.getElementById("saveScene").addEventListener("click",()=>{var a=document.createElement("div");a.setAttribute("id","warningBG"),a.setAttribute("class","warningBG"),a.innerHTML=`
      <div id="warningBlock">
