 ...
 * @license  MIT
 */(function(F){var b=base64Js,Q=ieee754$1,D=isarray;F.Buffer=G,F.SlowBuffer=Be,F.INSPECT_MAX_BYTES=50,G.TYPED_ARRAY_SUPPORT={}.TYPED_ARRAY_SUPPORT!==void 0?{}.TYPED_ARRAY_SUPPORT:O(),F.kMaxLength=U();function O(){try{var J=new Uint8Array(1);return J.__proto__={__proto__:Uint8Array.prototype,foo:function(){return 42}},J.foo()===42&&typeof J.subarray=="function"&&J.subarray(1,1).byteLength===0}catch{return!1}}function U(){return G.TYPED_ARRAY_SUPPORT?2147483647:1073741823}function q(J,W){if(U()<W)throw new RangeError("Invalid typed array length");return G.TYPED_ARRAY_SUPPORT?(J=new Uint8Array(W),J.__proto__=G.prototype):(J===null&&(J=new G(W)),J.length=W),J}function G(J,W,Z){if(!G.TYPED_ARRAY_SUPPORT&&!(this instanceof G))return new G(J,W,Z);if(typeof J=="number"){if(typeof W=="string")throw new Error("If encoding is specified then the first argument must be a string");return re(this,J)}return Y(this,J,W,Z)}G.poolSize=8192,G._augment=function(J){return J.__proto__=G.prototype,J};function Y(J,W,Z,se){if(typeof W=="number")throw new TypeError('"value" argument must not be a number');return typeof ArrayBuffer!="undefined"&&W instanceof ArrayBuffer?ce(J,W,Z,se):typeof W=="string"?ie(J,W,Z):Ae(J,W)}G.from=function(J,W,Z){return Y(null,J,W,Z)},G.TYPED_ARRAY_SUPPORT&&(G.prototype.__proto__=Uint8Array.prototype,G.__proto__=Uint8Array,typeof Symbol!="undefined"&&Symbol.species&&G[Symbol.species]===G&&Object.defineProperty(G,Symbol.species,{value:null,configurable:!0}));function X(J){if(typeof J!="number")throw new TypeError('"size" argument must be a number');if(J<0)throw new RangeError('"size" argument must not be negative')}function ee(J,W,Z,se){return X(W),W<=0?q(J,W):Z!==void 0?typeof se=="string"?q(J,W).fill(Z,se):q(J,W).fill(Z):q(J,W)}G.alloc=function(J,W,Z){return ee(null,J,W,Z)};function re(J,W){if(X(W),J=q(J,W<0?0:ge(W)|0),!G.TYPED_ARRAY_SUPPORT)for(var Z=0;Z<W;++Z)J[Z]=0;return J}G.allocUnsafe=function(J){return re(null,J)},G.allocUnsafeSlow=function(J){return re(null,J)};function ie(J,W,Z){if((typeof Z!="string"||Z==="")&&(Z="utf8"),!G.isEncoding(Z))throw new TypeError('"encoding" must be a valid string encoding');var se=Ie(W,Z)|0;J=q(J,se);var ue=J.write(W,Z);return ue!==se&&(J=J.slice(0,ue)),J}function ae(J,W){var Z=W.length<0?0:ge(W.length)|0;J=q(J,Z);for(var se=0;se<Z;se+=1)J[se]=W[se]&255;return J}function ce(J,W,Z,se){if(W.byteLength,Z<0||W.byteLength<Z)throw new RangeError("'offset' is out of bounds");if(W.byteLength<Z+(se||0))throw new RangeError("'length' is out of bounds");return Z===void 0&&se===void 0?W=new Uint8Array(W):se===void 0?W=new Uint8Array(W,Z):W=new Uint8Array(W,Z,se),G.TYPED_ARRAY_SUPPORT?(J=W,J.__proto__=G.prototype):J=ae(J,W),J}function Ae(J,W){if(G.isBuffer(W)){var Z=ge(W.length)|0;return J=q(J,Z),J.length===0||W.copy(J,0,0,Z),J}if(W){if(typeof ArrayBuffer!="undefined"&&W.buffer instanceof ArrayBuffer||"length"in W)return typeof W.length!="number"||te(W.length)?q(J,0):ae(J,W);if(W.type==="Buffer"&&D(W.data))return ae(J,W.data)}throw new TypeError("First argument must be a string, Buffer, ArrayBuffer, Array, or array-like object.")}function ge(J){if(J>=U())throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+U().toString(16)+" bytes");return J|0}function Be(J){return+J!=J&&(J=0),G.alloc(+J)}G.isBuffer=function(W){return!!(W!=null&&W._isBuffer)},G.compare=function(W,Z){if(!G.isBuffer(W)||!G.isBuffer(Z))throw new TypeError("Arguments must be Buffers");if(W===Z)return 0;for(var se=W.length,ue=Z.length,Ee=0,we=Math.min(se,ue);Ee<we;++Ee)if(W[Ee]!==Z[Ee]){se=W[Ee],ue=Z[Ee];break}return se<ue?-1:ue<se?1:0},G.isEncoding=function(W){switch(String(W).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},G.concat=function(W,Z){if(!D(W))throw new TypeError('"list" argument must be an Array of Buffers');if(W.length===0)return G.alloc(0);var se;if(Z===void 0)for(Z=0,se=0;se<W.length;++se)Z+=W[se].length;var ue=G.allocUnsafe(Z),Ee=0;for(se=0;se<W.length;++se){var we=W[se];if(!G.isBuffer(we))throw new TypeError('"list" argument must be an Array of Buffers');we.copy(ue,Ee),Ee+=we.length}return ue};function Ie(J,W){if(G.isBuffer(J))return J.length;if(typeof ArrayBuffer!="undefined"&&typeof ArrayBuffer.isView=="function"&&(ArrayBuffer.isView(J)||J instanceof ArrayBuffer))return J.byteLength;typeof J!="string"&&(J=""+J);var Z=J.length;if(Z===0)return 0;for(var se=!1;;)switch(W){case"ascii":case"latin1":case"binary":return Z;case"utf8":case"utf-8":case void 0:return he(J).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Z*2;case"hex":return Z>>>1;case"base64":return me(J).length;default:if(se)return he(J).length;W=(""+W).toLowerCase(),se=!0}}G.byteLength=Ie;function _e(J,W,Z){var se=!1;if((W===void 0||W<0)&&(W=0),W>this.length||((Z===void 0||Z>this.length)&&(Z=this.length),Z<=0)||(Z>>>=0,W>>>=0,Z<=W))return"";for(J||(J="utf8");;)switch(J){case"hex":return Ge(this,W,Z);case"utf8":case"utf-8":return Ve(this,W,Z);case"ascii":return xe(this,W,Z);case"latin1":case"binary":return Ne(this,W,Z);case"base64":return qe(this,W,Z);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Pe(this,W,Z);default:if(se)throw new TypeError("Unknown encoding: "+J);J=(J+"").toLowerCase(),se=!0}}G.prototype._isBuffer=!0;function Ce(J,W,Z){var se=J[W];J[W]=J[Z],J[Z]=se}G.prototype.swap16=function(){var W=this.length;if(W%2!==0)throw new RangeError("Buffer size must be a multiple of 16-bits");for(var Z=0;Z<W;Z+=2)Ce(this,Z,Z+1);return this},G.prototype.swap32=function(){var W=this.length;if(W%4!==0)throw new RangeError("Buffer size must be a multiple of 32-bits");for(var Z=0;Z<W;Z+=4)Ce(this,Z,Z+3),Ce(this,Z+1,Z+2);return this},G.prototype.swap64=function(){var W=this.length;if(W%8!==0)throw new RangeError("Buffer size must be a multiple of 64-bits");for(var Z=0;Z<W;Z+=8)Ce(this,Z,Z+7),Ce(this,Z+1,Z+6),Ce(this,Z+2,Z+5),Ce(this,Z+3,Z+4);return this},G.prototype.toString=function(){var W=this.length|0;return W===0?"":arguments.length===0?Ve(this,0,W):_e.apply(this,arguments)},G.prototype.equals=function(W){if(!G.isBuffer(W))throw new TypeError("Argument must be a Buffer");return this===W?!0:G.compare(this,W)===0},G.prototype.inspect=function(){var W="",Z=F.INSPECT_MAX_BYTES;return this.length>0&&(W=this.toString("hex",0,Z).match(/.{2}/g).join(" "),this.length>Z&&(W+=" ... ")),"<Buffer "+W+">"},G.prototype.compare=function(W,Z,se,ue,Ee){if(!G.isBuffer(W))throw new TypeError("Argument must be a Buffer");if(Z===void 0&&(Z=0),se===void 0&&(se=W?W.length:0),ue===void 0&&(ue=0),Ee===void 0&&(Ee=this.length),Z<0||se>W.length||ue<0||Ee>this.length)throw new RangeError("out of range index");if(ue>=Ee&&Z>=se)return 0;if(ue>=Ee)return-1;if(Z>=se)return 1;if(Z>>>=0,se>>>=0,ue>>>=0,Ee>>>=0,this===W)return 0;for(var we=Ee-ue,Oe=se-Z,He=Math.min(we,Oe),Re=this.slice(ue,Ee),Je=W.slice(Z,se),ze=0;ze<He;++ze)if(Re[ze]!==Je[ze]){we=Re[ze],Oe=Je[ze];break}return we<Oe?-1:Oe<we?1:0};function ve(J,W,Z,se,ue){if(J.length===0)return-1;if(typeof Z=="string"?(se=Z,Z=0):Z>2147483647?Z=2147483647:Z<-2147483648&&(Z=-2147483648),Z=+Z,isNaN(Z)&&(Z=ue?0:J.length-1),Z<0&&(Z=J.length+Z),Z>=J.length){if(ue)return-1;Z=J.length-1}else if(Z<0)if(ue)Z=0;else return-1;if(typeof W=="string"&&(W=G.from(W,se)),G.isBuffer(W))return W.length===0?-1:Qe(J,W,Z,se,ue);if(typeof W=="number")return W=W&255,G.TYPED_ARRAY_SUPPORT&&typeof Uint8Array.prototype.indexOf=="function"?ue?Uint8Array.prototype.indexOf.call(J,W,Z):Uint8Array.prototype.lastIndexOf.call(J,W,Z):Qe(J,[W],Z,se,ue);throw new TypeError("val must be string, number or Buffer")}function Qe(J,W,Z,se,ue){var Ee=1,we=J.length,Oe=W.length;if(se!==void 0&&(se=String(se).toLowerCase(),se==="ucs2"||se==="ucs-2"||se==="utf16le"||se==="utf-16le")){if(J.length<2||W.length<2)return-1;Ee=2,we/=2,Oe/=2,Z/=2}function He(ht,gt){return Ee===1?ht[gt]:ht.readUInt16BE(gt*Ee)}var Re;if(ue){var Je=-1;for(Re=Z;Re<we;Re++)if(He(J,Re)===He(W,Je===-1?0:Re-Je)){if(Je===-1&&(Je=Re),Re-Je+1===Oe)return Je*Ee}else Je!==-1&&(Re-=Re-Je),Je=-1}else for(Z+Oe>we&&(Z=we-Oe),Re=Z;Re>=0;Re--){for(var ze=!0,ct=0;ct<Oe;ct++)if(He(J,Re+ct)!==He(W,ct)){ze=!1;break}if(ze)return Re}return-1}G.prototype.includes=function(W,Z,se){return this.indexOf(W,Z,se)!==-1},G.prototype.indexOf=function(W,Z,se){return ve(this,W,Z,se,!0)},G.prototype.lastIndexOf=function(W,Z,se){return ve(this,W,Z,se,!1)};function Se(J,W,Z,se){Z=Number(Z)||0;var ue=J.length-Z;se?(se=Number(se),se>ue&&(se=ue)):se=ue;var Ee=W.length;if(Ee%2!==0)throw new TypeError("Invalid hex string");se>Ee/2&&(se=Ee/2);for(var we=0;we<se;++we){var Oe=parseInt(W.substr(we*2,2),16);if(isNaN(Oe))return we;J[Z+we]=Oe}return we}function Me(J,W,Z,se){return ne(he(W,J.length-Z),J,Z,se)}function ke(J,W,Z,se){return ne(ye(W),J,Z,se)}function Fe(J,W,Z,se){return ke(J,W,Z,se)}function Ue(J,W,Z,se){return ne(me(W),J,Z,se)}function Ye(J,W,Z,se){return ne(pe(W,J.length-Z),J,Z,se)}G.prototype.write=function(W,Z,se,ue){if(Z===void 0)ue="utf8",se=this.length,Z=0;else if(se===void 0&&typeof Z=="string")ue=Z,se=this.length,Z=0;else if(isFinite(Z))Z=Z|0,isFinite(se)?(se=se|0,ue===void 0&&(ue="utf8")):(ue=se,se=void 0);else throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");var Ee=this.length-Z;if((se===void 0||se>Ee)&&(se=Ee),W.length>0&&(se<0||Z<0)||Z>this.length)throw new RangeError("Attempt to write outside buffer bounds");ue||(ue="utf8");for(var we=!1;;)switch(ue){case"hex":return Se(this,W,Z,se);case"utf8":case"utf-8":return Me(this,W,Z,se);case"ascii":return ke(this,W,Z,se);case"latin1":case"binary":return Fe(this,W,Z,se);case"base64":return Ue(this,W,Z,se);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Ye(this,W,Z,se);default:if(we)throw new TypeError("Unknown encoding: "+ue);ue=(""+ue).toLowerCase(),we=!0}},G.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}};function qe(J,W,Z){return W===0&&Z===J.length?b.fromByteArray(J):b.fromByteArray(J.slice(W,Z))}function Ve(J,W,Z){Z=Math.min(J.length,Z);for(var se=[],ue=W;ue<Z;){var Ee=J[ue],we=null,Oe=Ee>239?4:Ee>223?3:Ee>191?2:1;if(ue+Oe<=Z){var He,Re,Je,ze;switch(Oe){case 1:Ee<128&&(we=Ee);break;case 2:He=J[ue+1],(He&192)===128&&(ze=(Ee&31)<<6|He&63,ze>127&&(we=ze));break;case 3:He=J[ue+1],Re=J[ue+2],(He&192)===128&&(Re&192)===128&&(ze=(Ee&15)<<12|(He&63)<<6|Re&63,ze>2047&&(ze<55296||ze>57343)&&(we=ze));break;case 4:He=J[ue+1],Re=J[ue+2],Je=J[ue+3],(He&192)===128&&(Re&192)===128&&(Je&192)===128&&(ze=(Ee&15)<<18|(He&63)<<12|(Re&63)<<6|Je&63,ze>65535&&ze<1114112&&(we=ze))}}we===null?(we=65533,Oe=1):we>65535&&(we-=65536,se.push(we>>>10&1023|55296),we=56320|we&1023),se.push(we),ue+=Oe}return De(se)}var Te=4096;function De(J){var W=J.length;if(W<=Te)return String.fromCharCode.apply(String,J);for(var Z="",se=0;se<W;)Z+=String.fromCharCode.apply(String,J.slice(se,se+=Te));return Z}function xe(J,W,Z){var se="";Z=Math.min(J.length,Z);for(var ue=W;ue<Z;++ue)se+=String.fromCharCode(J[ue]&127);return se}function Ne(J,W,Z){var se="";Z=Math.min(J.length,Z);for(var ue=W;ue<Z;++ue)se+=String.fromCharCode(J[ue]);return se}function Ge(J,W,Z){var se=J.length;(!W||W<0)&&(W=0),(!Z||Z<0||Z>se)&&(Z=se);for(var ue="",Ee=W;Ee<Z;++Ee)ue+=oe(J[Ee]);return ue}function Pe(J,W,Z){for(var se=J.slice(W,Z),ue="",Ee=0;Ee<se.length;Ee+=2)ue+=String.fromCharCode(se[Ee]+se[Ee+1]*256);return ue}G.prototype.slice=function(W,Z){var se=this.length;W=~~W,Z=Z===void 0?se:~~Z,W<0?(W+=se,W<0&&(W=0)):W>se&&(W=se),Z<0?(Z+=se,Z<0&&(Z=0)):Z>se&&(Z=se),Z<W&&(Z=W);var ue;if(G.TYPED_ARRAY_SUPPORT)ue=this.subarray(W,Z),ue.__proto__=G.prototype;else{var Ee=Z-W;ue=new G(Ee,void 0);for(var we=0;we<Ee;++we)ue[we]=this[we+W]}return ue};function Le(J,W,Z){if(J%1!==0||J<0)throw new RangeError("offset is not uint");if(J+W>Z)throw new RangeError("Trying to access beyond buffer length")}G.prototype.readUIntLE=function(W,Z,se){W=W|0,Z=Z|0,se||Le(W,Z,this.length);for(var ue=this[W],Ee=1,we=0;++we<Z&&(Ee*=256);)ue+=this[W+we]*Ee;return ue},G.prototype.readUIntBE=function(W,Z,se){W=W|0,Z=Z|0,se||Le(W,Z,this.length);for(var ue=this[W+--Z],Ee=1;Z>0&&(Ee*=256);)ue+=this[W+--Z]*Ee;return ue},G.prototype.readUInt8=function(W,Z){return Z||Le(W,1,this.length),this[W]},G.prototype.readUInt16LE=function(W,Z){return Z||Le(W,2,this.length),this[W]|this[W+1]<<8},G.prototype.readUInt16BE=function(W,Z){return Z||Le(W,2,this.length),this[W]<<8|this[W+1]},G.prototype.readUInt32LE=function(W,Z){return Z||Le(W,4,this.length),(this[W]|this[W+1]<<8|this[W+2]<<16)+this[W+3]*16777216},G.prototype.readUInt32BE=function(W,Z){return Z||Le(W,4,this.length),this[W]*16777216+(this[W+1]<<16|this[W+2]<<8|this[W+3])},G.prototype.readIntLE=function(W,Z,se){W=W|0,Z=Z|0,se||Le(W,Z,this.length);for(var ue=this[W],Ee=1,we=0;++we<Z&&(Ee*=256);)ue+=this[W+we]*Ee;return Ee*=128,ue>=Ee&&(ue-=Math.pow(2,8*Z)),ue},G.prototype.readIntBE=function(W,Z,se){W=W|0,Z=Z|0,se||Le(W,Z,this.length);for(var ue=Z,Ee=1,we=this[W+--ue];ue>0&&(Ee*=256);)we+=this[W+--ue]*Ee;return Ee*=128,we>=Ee&&(we-=Math.pow(2,8*Z)),we},G.prototype.readInt8=function(W,Z){return Z||Le(W,1,this.length),this[W]&128?(255-this[W]+1)*-1:this[W]},G.prototype.readInt16LE=function(W,Z){Z||Le(W,2,this.length);var se=this[W]|this[W+1]<<8;return se&32768?se|4294901760:se},G.prototype.readInt16BE=function(W,Z){Z||Le(W,2,this.length);var se=this[W+1]|this[W]<<8;return se&32768?se|4294901760:se},G.prototype.readInt32LE=function(W,Z){return Z||Le(W,4,this.length),this[W]|this[W+1]<<8|this[W+2]<<16|this[W+3]<<24},G.prototype.readInt32BE=function(W,Z){return Z||Le(W,4,this.length),this[W]<<24|this[W+1]<<16|this[W+2]<<8|this[W+3]},G.prototype.readFloatLE=function(W,Z){return Z||Le(W,4,this.length),Q.read(this,W,!0,23,4)},G.prototype.readFloatBE=function(W,Z){return Z||Le(W,4,this.length),Q.read(this,W,!1,23,4)},G.prototype.readDoubleLE=function(W,Z){return Z||Le(W,8,this.length),Q.read(this,W,!0,52,8)},G.prototype.readDoubleBE=function(W,Z){return Z||Le(W,8,this.length),Q.read(this,W,!1,52,8)};function $e(J,W,Z,se,ue,Ee){if(!G.isBuffer(J))throw new TypeError('"buffer" argument must be a Buffer instance');if(W>ue||W<Ee)throw new RangeError('"value" argument is out of bounds');if(Z+se>J.length)throw new RangeError("Index out of range")}G.prototype.writeUIntLE=function(W,Z,se,ue){if(W=+W,Z=Z|0,se=se|0,!ue){var Ee=Math.pow(2,8*se)-1;$e(this,W,Z,se,Ee,0)}var we=1,Oe=0;for(this[Z]=W&255;++Oe<se&&(we*=256);)this[Z+Oe]=W/we&255;return Z+se},G.prototype.writeUIntBE=function(W,Z,se,ue){if(W=+W,Z=Z|0,se=se|0,!ue){var Ee=Math.pow(2,8*se)-1;$e(this,W,Z,se,Ee,0)}var we=se-1,Oe=1;for(this[Z+we]=W&255;--we>=0&&(Oe*=256);)this[Z+we]=W/Oe&255;return Z+se},G.prototype.writeUInt8=function(W,Z,se){return W=+W,Z=Z|0,se||$e(this,W,Z,1,255,0),G.TYPED_ARRAY_SUPPORT||(W=Math.floor(W)),this[Z]=W&255,Z+1};function et(J,W,Z,se){W<0&&(W=65535+W+1);for(var ue=0,Ee=Math.min(J.length-Z,2);ue<Ee;++ue)J[Z+ue]=(W&255<<8*(se?ue:1-ue))>>>(se?ue:1-ue)*8}G.prototype.writeUInt16LE=function(W,Z,se){return W=+W,Z=Z|0,se||$e(this,W,Z,2,65535,0),G.TYPED_ARRAY_SUPPORT?(this[Z]=W&255,this[Z+1]=W>>>8):et(this,W,Z,!0),Z+2},G.prototype.writeUInt16BE=function(W,Z,se){return W=+W,Z=Z|0,se||$e(this,W,Z,2,65535,0),G.TYPED_ARRAY_SUPPORT?(this[Z]=W>>>8,this[Z+1]=W&255):et(this,W,Z,!1),Z+2};function de(J,W,Z,se){W<0&&(W=4294967295+W+1);for(var ue=0,Ee=Math.min(J.length-Z,4);ue<Ee;++ue)J[Z+ue]=W>>>(se?ue:3-ue)*8&255}G.prototype.writeUInt32LE=function(W,Z,se){return W=+W,Z=Z|0,se||$e(this,W,Z,4,4294967295,0),G.TYPED_ARRAY_SUPPORT?(this[Z+3]=W>>>24,this[Z+2]=W>>>16,this[Z+1]=W>>>8,this[Z]=W&255):de(this,W,Z,!0),Z+4},G.prototype.writeUInt32BE=function(W,Z,se){return W=+W,Z=Z|0,se||$e(this,W,Z,4,4294967295,0),G.TYPED_ARRAY_SUPPORT?(this[Z]=W>>>24,this[Z+1]=W>>>16,this[Z+2]=W>>>8,this[Z+3]=W&255):de(this,W,Z,!1),Z+4},G.prototype.writeIntLE=function(W,Z,se,ue){if(W=+W,Z=Z|0,!ue){var Ee=Math.pow(2,8*se-1);$e(this,W,Z,se,Ee-1,-Ee)}var we=0,Oe=1,He=0;for(this[Z]=W&255;++we<se&&(Oe*=256);)W<0&&He===0&&this[Z+we-1]!==0&&(He=1),this[Z+we]=(W/Oe>>0)-He&255;return Z+se},G.prototype.writeIntBE=function(W,Z,se,ue){if(W=+W,Z=Z|0,!ue){var Ee=Math.pow(2,8*se-1);$e(this,W,Z,se,Ee-1,-Ee)}var we=se-1,Oe=1,He=0;for(this[Z+we]=W&255;--we>=0&&(Oe*=256);)W<0&&He===0&&this[Z+we+1]!==0&&(He=1),this[Z+we]=(W/Oe>>0)-He&255;return Z+se},G.prototype.writeInt8=function(W,Z,se){return W=+W,Z=Z|0,se||$e(this,W,Z,1,127,-128),G.TYPED_ARRAY_SUPPORT||(W=Math.floor(W)),W<0&&(W=255+W+1),this[Z]=W&255,Z+1},G.prototype.writeInt16LE=function(W,Z,se){return W=+W,Z=Z|0,se||$e(this,W,Z,2,32767,-32768),G.TYPED_ARRAY_SUPPORT?(this[Z]=W&255,this[Z+1]=W>>>8):et(this,W,Z,!0),Z+2},G.prototype.writeInt16BE=function(W,Z,se){return W=+W,Z=Z|0,se||$e(this,W,Z,2,32767,-32768),G.TYPED_ARRAY_SUPPORT?(this[Z]=W>>>8,this[Z+1]=W&255):et(this,W,Z,!1),Z+2},G.prototype.writeInt32LE=function(W,Z,se){return W=+W,Z=Z|0,se||$e(this,W,Z,4,2147483647,-2147483648),G.TYPED_ARRAY_SUPPORT?(this[Z]=W&255,this[Z+1]=W>>>8,this[Z+2]=W>>>16,this[Z+3]=W>>>24):de(this,W,Z,!0),Z+4},G.prototype.writeInt32BE=function(W,Z,se){return W=+W,Z=Z|0,se||$e(this,W,Z,4,2147483647,-2147483648),W<0&&(W=4294967295+W+1),G.TYPED_ARRAY_SUPPORT?(this[Z]=W>>>24,this[Z+1]=W>>>16,this[Z+2]=W>>>8,this[Z+3]=W&255):de(this,W,Z,!1),Z+4};function tt(J,W,Z,se,ue,Ee){if(Z+se>J.length)throw new RangeError("Index out of range");if(Z<0)throw new RangeError("Index out of range")}function at(J,W,Z,se,ue){return ue||tt(J,W,Z,4),Q.write(J,W,Z,se,23,4),Z+4}G.prototype.writeFloatLE=function(W,Z,se){return at(this,W,Z,!0,se)},G.prototype.writeFloatBE=function(W,Z,se){return at(this,W,Z,!1,se)};function dt(J,W,Z,se,ue){return ue||tt(J,W,Z,8),Q.write(J,W,Z,se,52,8),Z+8}G.prototype.writeDoubleLE=function(W,Z,se){return dt(this,W,Z,!0,se)},G.prototype.writeDoubleBE=function(W,Z,se){return dt(this,W,Z,!1,se)},G.prototype.copy=function(W,Z,se,ue){if(se||(se=0),!ue&&ue!==0&&(ue=this.length),Z>=W.length&&(Z=W.length),Z||(Z=0),ue>0&&ue<se&&(ue=se),ue===se||W.length===0||this.length===0)return 0;if(Z<0)throw new RangeError("targetStart out of bounds");if(se<0||se>=this.length)throw new RangeError("sourceStart out of bounds");if(ue<0)throw new RangeError("sourceEnd out of bounds");ue>this.length&&(ue=this.length),W.length-Z<ue-se&&(ue=W.length-Z+se);var Ee=ue-se,we;if(this===W&&se<Z&&Z<ue)for(we=Ee-1;we>=0;--we)W[we+Z]=this[we+se];else if(Ee<1e3||!G.TYPED_ARRAY_SUPPORT)for(we=0;we<Ee;++we)W[we+Z]=this[we+se];else Uint8Array.prototype.set.call(W,this.subarray(se,se+Ee),Z);return Ee},G.prototype.fill=function(W,Z,se,ue){if(typeof W=="string"){if(typeof Z=="string"?(ue=Z,Z=0,se=this.length):typeof se=="string"&&(ue=se,se=this.length),W.length===1){var Ee=W.charCodeAt(0);Ee<256&&(W=Ee)}if(ue!==void 0&&typeof ue!="string")throw new TypeError("encoding must be a string");if(typeof ue=="string"&&!G.isEncoding(ue))throw new TypeError("Unknown encoding: "+ue)}else typeof W=="number"&&(W=W&255);if(Z<0||this.length<Z||this.length<se)throw new RangeError("Out of range index");if(se<=Z)return this;Z=Z>>>0,se=se===void 0?this.length:se>>>0,W||(W=0);var we;if(typeof W=="number")for(we=Z;we<se;++we)this[we]=W;else{var Oe=G.isBuffer(W)?W:he(new G(W,ue).toString()),He=Oe.length;for(we=0;we<se-Z;++we)this[we+Z]=Oe[we%He]}return this};var je=/[^+\/0-9A-Za-z-_]/g;function be(J){if(J=le(J).replace(je,""),J.length<2)return"";for(;J.length%4!==0;)J=J+"=";return J}function le(J){return J.trim?J.trim():J.replace(/^\s+|\s+$/g,"")}function oe(J){return J<16?"0"+J.toString(16):J.toString(16)}function he(J,W){W=W||1/0;for(var Z,se=J.length,ue=null,Ee=[],we=0;we<se;++we){if(Z=J.charCodeAt(we),Z>55295&&Z<57344){if(!ue){if(Z>56319){(W-=3)>-1&&Ee.push(239,191,189);continue}else if(we+1===se){(W-=3)>-1&&Ee.push(239,191,189);continue}ue=Z;continue}if(Z<56320){(W-=3)>-1&&Ee.push(239,191,189),ue=Z;continue}Z=(ue-55296<<10|Z-56320)+65536}else ue&&(W-=3)>-1&&Ee.push(239,191,189);if(ue=null,Z<128){if((W-=1)<0)break;Ee.push(Z)}else if(Z<2048){if((W-=2)<0)break;Ee.push(Z>>6|192,Z&63|128)}else if(Z<65536){if((W-=3)<0)break;Ee.push(Z>>12|224,Z>>6&63|128,Z&63|128)}else if(Z<1114112){if((W-=4)<0)break;Ee.push(Z>>18|240,Z>>12&63|128,Z>>6&63|128,Z&63|128)}else throw new Error("Invalid code point")}return Ee}function ye(J){for(var W=[],Z=0;Z<J.length;++Z)W.push(J.charCodeAt(Z)&255);return W}function pe(J,W){for(var Z,se,ue,Ee=[],we=0;we<J.length&&!((W-=2)<0);++we)Z=J.charCodeAt(we),se=Z>>8,ue=Z%256,Ee.push(ue),Ee.push(se);return Ee}function me(J){return b.toByteArray(be(J))}function ne(J,W,Z,se){for(var ue=0;ue<se&&!(ue+Z>=W.length||ue>=J.length);++ue)W[ue+Z]=J[ue];return ue}function te(J){return J!==J}})(buffer$1);window.Buffer=buffer$1.Buffer;__vitePreload(()=>import("./index.9df69666.js").then(function(F){return F.i}),[]).then(F=>{window.getAllUserNFTs=F.getAllUserNFTs}).catch(F=>{console.log(F)});async function universe(){const F=new SoundtrackManager;var b=document.querySelector("#universe"),Q=document.querySelector("#exploreUI"),D=document.getElementById("previewUI"),O=document.getElementById("explore"),U=document.getElementById("getUniMenu").shadowRoot.getElementById("pinMenu"),q=document.getElementById("getUniMenu").shadowRoot.getElementById("locked"),G=document.getElementById("getUniMenu").shadowRoot.getElementById("uniMenu"),Y={x:0,y:0},X={x:0,y:0},ee={x:0,y:0},re={x:0,y:0},ie,ae,ce=18,Ae=0,ge=50,Be=50,Ie=50,_e=50,Ce=!1,ve,Qe,Se=!1,Me=!1;window.connected=!1;var ke=["1435","3162","2849","6208"];window.suUiActor=null,window.landActivated=!1,window.chatActive=!1,window.domainType="",window.user={principal:null,balance:null,pk:null,nfts:null};const Fe="X6X8vw.njyFHg:fbgHjcgXOfW9qxBg69sRw0OK6yHpBKqtvbOcGVSh3e0",Ue=new Ably.Realtime.Promise(Fe),Ye=Ue.channels.get("alphaTestersChat"),qe=Ue.channels.get("lordsInTheCity");(()=>{console.log("test"),document.addEventListener("keydown",function(be){be.keyCode===80&&newScenario("Intro")})})(),window.universeSystem=async()=>{var be=b.getContext("2d"),le=document.createElement("img"),oe=document.getElementById("camera");if(F.stop("menuEntrance1"),F.play("menuEntrance1"),navigator.userAgent.includes("Brave")||navigator.userAgent.includes("Firefox")||navigator.userAgent.includes("Chrome")){document.querySelector("#universe").style.display="block",setTimeout(()=>{document.querySelector("#universe").style.opacity="100%"},100),le.onload=function(){be.drawImage(le,0,0,le.width,le.height),be.fillStyle="rgba(255, 255, 255, 0.08)";for(var ne=0;ne<le.width;ne+=ce)be.fillRect(ne,0,1,le.height);for(var te=0;te<le.height;te+=ce)be.fillRect(0,te,le.width,1)},le.src="https://storage.scoge.co/b2612349-1217-4db2-af51-c5424a50e5c1-bucket/Images/uniMap/scoge-taos-city-universe.jpg",oe.scrollTo(990,0),oe.addEventListener("scroll",function(){oe.scrollLeft<990&&oe.scrollTo(990,0),oe.style.overflowY="hidden"},{passive:!1}),oe.addEventListener("wheel",function(ne){ne.preventDefault()},{passive:!1}),b.addEventListener("mousemove",window.mousePos),b.addEventListener("click",window.selectedPos),document.addEventListener("focus",ne=>{Me=!0},!0),document.addEventListener("blur",ne=>{Me=!1},!0);var he=document.createElement("div"),ye=document.createElement("div"),pe=document.createElement("div"),me=document.createElement("div");he.id="uniEvent",he.setAttribute("class","uniEvents"),document.getElementById("camera").appendChild(he),ye.id="uniEvent2",ye.setAttribute("class","uniEvents"),document.getElementById("camera").appendChild(ye),pe.id="uniEvent3",pe.setAttribute("class","uniEvents"),document.getElementById("camera").appendChild(pe),me.id="uniEvent4",me.setAttribute("class","uniEvents"),document.getElementById("camera").appendChild(me),window.adminUI(),window.openLocationCard(),window.playerPos(),window.currentSx=newScenario("Intro")}else alert("The browser is not Brave, Firefox, or Chrome");Ne()&&De()};var Te=!1;const De=()=>{var be=document.createElement("div");be.id="viewEditor",be.style.right="2%",be.style.top="3%",be.style.position="fixed",be.style.zIndex="501",be.style.width="40px",be.style.height="40px",be.style.backgroundColor="rgba(0, 0, 0, 0.9)",be.style.borderRadius="10px",be.style.border="1px solid #ff002d",be.addEventListener("click",async()=>{var oe=(await __vitePreload(()=>import("./editor.e32081bf.js"),["assets/editor.e32081bf.js","assets/wScoge.fc00b881.js","assets/wScoge.2197177c.css"])).editor(Te);oe===!1?Te=!1:Te=!0}),document.getElementById("main").appendChild(be)};window.adminUI=()=>{var be=document.createElement("div"),le=document.createElement("div"),oe=document.createElement("div"),he=document.createElement("div"),ye=document.createElement("div"),pe=document.createElement("div"),me=document.createElement("div"),ne=document.createElement("div");document.getElementById("selection").style.display="block",be.id="adminUI",le.id="DebugColumn",oe.id="DebugRow",he.id="selectionPos",ye.id="pixelPos",pe.id="selectPosBox",me.id="playerCord",ne.id="playerScreenCoor",be.appendChild(ye),be.appendChild(le),be.appendChild(oe),be.appendChild(he),be.appendChild(pe),be.appendChild(me),be.appendChild(ne),document.getElementById("main").appendChild(be),xe(document.getElementById("adminUI"),!0),xe(document.getElementById("exploreUI"),!0),he.innerHTML="Selected Tile:",le.innerHTML="Column:",oe.innerHTML="Row:",ye.innerHTML="X: , Y:",pe.innerHTML="SelBoxTile:",me.innerHTML="Player Coordinates:",ne.innerHTML="Player Screen Coord:",window.initSelection(),window.moveSelection(),window.moveMenu()},window.mousePos=be=>{var le=b.getBoundingClientRect();Y.x=Math.round((be.clientX-le.left)/ce),Y.y=Math.round((be.clientY-le.top)/ce),window.pixelPos.x=be.clientX-le.left,window.pixelPos.y=be.clientY-le.top,document.getElementById("DebugColumn").innerHTML="Column: "+Y.x,document.getElementById("DebugRow").innerHTML="Row: "+Y.y,document.getElementById("pixelPos").innerHTML="X: "+window.pixelPos.x+", Y: "+window.pixelPos.y},window.selectedPos=be=>{window.chatActive=!1,document.getElementById("explore").style.display="block";var le=b.getBoundingClientRect();Q.style.transform="scale(0)",X.x=Math.round((be.clientX-(le.left+9))/ce),X.y=Math.round((be.clientY-(le.top+9))/ce);var oe=170-X.x;if(document.getElementById("selectionPos").innerHTML="Selected Tile: "+(170-oe+170*X.y),Ae=170-oe+170*X.y,ae=170-oe+170*X.y,D.innerHTML="Land "+Ae,D.style.color="blue",O.style.left=be.clientX-O.offsetWidth/2+"px",O.style.top=be.clientY-O.offsetHeight/2+"px",O.style.left=Math.round((O.offsetLeft-le.left)/ce)*ce+le.left+"px",O.style.top=Math.round((O.offsetTop-le.top)/ce)*ce+le.top+"px",D.style.display="block",D.style.left=O.offsetLeft+O.offsetWidth+18+"px",D.style.top=O.offsetTop-108+"px",D.style.transformOrigin="bottom left",O.offsetTop<215&&(D.style.top=O.offsetTop+O.offsetHeight+18+"px",D.style.transformOrigin="top left"),O.offsetLeft>window.innerWidth-215&&(D.style.left=O.offsetLeft-D.offsetWidth-18+"px",D.style.transformOrigin="bottom right"),O.offsetLeft<215&&(D.style.transformOrigin="bottom left"),Se==!1){D.style.transform="scale(1)",Se=!0,ve=setTimeout(()=>{D.style.transform="scale(0)",Se=!1},3e3);return}if(Se==!0){clearTimeout(ve),ve=setTimeout(()=>{D.style.transform="scale(0)",Se=!1},3e3);return}};function xe(be,le){var oe=0,he=0,ye=0,pe=0;if(le===!1)return;U.style.borderTop="2px solid rgba(225, 225, 225, 0.8)",U.style.borderLeft="2px solid rgba(225, 225, 225, 0.8)",U.style.filter="blur(0px)",U.setAttribute("class","unpinned"),q.style.opacity="0",document.getElementById(be.id+"header")?document.getElementById(be.id+"header").onmousedown=me:be.onmousedown=me;function me(J){J=J||window.event,J.preventDefault(),ye=J.clientX,pe=J.clientY,document.onmouseup=te,document.onmousemove=ne}function ne(J){J=J||window.event,J.preventDefault(),oe=ye-J.clientX,he=pe-J.clientY,ye=J.clientX,pe=J.clientY,be.style.top=be.offsetTop-he+"px",be.style.left=be.offsetLeft-oe+"px"}function te(){document.onmouseup=null,document.onmousemove=null}}window.deactivateDrag=()=>{G.onmousedown=null,document.onmouseup=null,document.onmousemove=null,U.style.borderTop="4px solid #ff002d",U.style.borderLeft="4px solid #ff002d",U.setAttribute("class","pinned"),q.style.opacity="1"},window.pinMenu=()=>{if(U.getAttribute("class")=="pinned"){xe(G,!0),U.setAttribute("class","unpinned");return}if(U.getAttribute("class")=="unpinned"){window.deactivateDrag(),U.setAttribute("class","pinned"),G.style.transition="1s",G.style.top="36px",G.style.left="36px",document.getElementById("getUniMenu").toggleMenu(),setTimeout(()=>{G.style.transition=""},1200);return}},window.playerPos=async()=>{var be=document.getElementById("selection"),le=b.getBoundingClientRect(),oe=be.getBoundingClientRect(),he={x:Math.round(oe.left-le.left+2),y:Math.round(oe.top-le.top+2)},ye={x:Math.round(he.x/ce),y:Math.round(Math.round(he.y/ce))},pe=170-ye.x,me=170-pe+ye.y*170;if(document.getElementById("selectPosBox").innerHTML=`Player Position: ${me}`,ie=170-pe+ye.y*170,re.x=he.x-2,re.y=he.y-2,document.getElementById("playerCord").innerHTML=`Player Coordinates: ${re.x}, ${re.y}`,document.getElementById("playerScreenCoor").innerHTML=`Player Screen Coordinates: ${oe.left}, ${Math.round(oe.top)+2}`,window.uniPlayer.x=be.style.left,window.uniPlayer.y=be.style.top,await qe.publish("lords",{roomId:tt,playerId:window.uniPlayer.playerId,playerData:window.uniPlayer}),`${me}`===ke[0]||`${me}`===ke[1]||`${me}`===ke[2]||`${me}`===ke[3]){if(window.landActivated=!0,document.getElementById("selection").style.animationPlayState="running",document.getElementById("selection").style.animation="whiteBoxGlow 1s infinite",document.getElementById("selection").innerHTML='<div id="exclamationMark" style="position: absolute; top: 8px; left: 8px; width: 18px; height: 18px; background-color: #ff002d; border-radius: 50%; display: flex; justify-content: center; align-items: center; font-size: 18px; color: #fff; font-weight: 700;">!</div>',`${me}`===ke[0]){window.domainType="canon",Q.innerHTML=Ge;return}else if(`${me}`===ke[1]){window.domainType="world",Q.innerHTML=Pe;return}else if(`${me}`===ke[2]){window.domainType="world",Q.innerHTML=Le;return}else if(`${me}`===ke[3]){window.domainType="chat",Q.innerHTML=$e;var ne=window.room1.getMessages();ne==null||ne.forEach(te=>{const J=document.createElement("div"),W=document.getElementById("chatRoom1");J.setAttribute("class","chatMessageContainer"),J.innerHTML=`
      ...
      `,W.appendChild(J)}),Q.addEventListener("keyup",()=>{xe(document.getElementById("exploreUI"),!0)}),document.getElementById("chatTextArea").addEventListener("click",()=>{Q.onmousedown=null,document.getElementById("chatInput1").focus()}),document.getElementById("sendBut").addEventListener("click",async()=>{var te=document.getElementById("chatInput1");const J=te.value.trim();J&&(window.room1.addMessage(J),await Ye.publish("chatRoom1",{roomMessage:J}),te.value="")});return}return}else window.landActivated=!1,document.getElementById("selection").style.animationPlayState="paused",document.getElementById("selection").style.animation="none",document.getElementById("selection").innerHTML="",Q.innerHTML=""};const Ne=()=>window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1";window.moveSelection=()=>{document.removeEventListener("keydown",window.checkKeys);var be=document.getElementById("selection"),le=window.innerHeight/ce,oe=window.innerWidth/ce,he=le/2,ye=oe/2;ee.x=ye*ce,ee.y=he*ce,document.addEventListener("keydown",function(pe){window.chatActive!=!0&&(Q.style.transform="scale(0)",xe(document.getElementById("exploreUI"),!0),pe.keyCode==37&&ee.x>0&&Ce==!1&&(ee.x-=ce,Ce=!0,setTimeout(()=>{Ce=!1},ge)),pe.keyCode==38&&ee.y>0&&Ce==!1&&(ee.y-=ce,Ce=!0,setTimeout(()=>{Ce=!1},Ie)),pe.keyCode==39&&ee.x<oe*ce-ce&&Ce==!1&&(ee.x+=ce,Ce=!0,setTimeout(()=>{Ce=!1},Be)),pe.keyCode==40&&ee.y<le*ce-ce&&Ce==!1&&(ee.y+=ce,Ce=!0,setTimeout(()=>{Ce=!1},_e)),be.style.left=ee.x+"px",be.style.top=ee.y+"px",window.playerPos(),pe.keyCode==32&&window.exploreOpenHelper())}),document.addEventListener("keydown",function(pe){pe.keyCode==37&&ee.x==0&&(document.getElementById("camera").scrollLeft-=ce),pe.keyCode==38&&ee.y==0&&(document.getElementById("camera").scrollTop-=ce),pe.keyCode==39&&ee.x==oe*ce-ce&&(document.getElementById("camera").scrollLeft+=ce),pe.keyCode==40&&ee.y==le*ce-ce&&(document.getElementById("camera").scrollTop+=ce);var me=document.getElementById("viewEditor"),ne=document.getElementById("selection"),te=Math.floor(window.innerWidth-Number(ne.style.left.replace("px",""))),J=Math.floor(Number(ne.style.top.replace("px","")));console.log(te,J);var W=Math.floor(window.innerHeight-Number(ne.style.top.replace("px","")));te<100&&J<100&&(me.style.top="auto",me.style.bottom="5%"),te<100&&W<100&&(me.style.top="5%",me.style.bottom="auto")})},window.initSelection=()=>{var be=window.innerWidth/ce,le=window.innerHeight/ce,oe=document.getElementById("selection");oe.style.left=be/2*ce+"px",oe.style.top=le/2*ce+"px"},window.openLocationCard=()=>{b.addEventListener("dblclick",()=>{if(document.getElementById("previewUI").style.transform="scale(0)",ie===ae)window.exploreOpenHelper();else{var be=document.getElementById("adminUI");be.style.opacity="1",setTimeout(()=>{be.style.opacity="0"},5e3)}})};var Ge=`<div class="cannonIcon">
