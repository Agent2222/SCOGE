 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const t$1=window,e$2=t$1.ShadowRoot&&(t$1.ShadyCSS===void 0||t$1.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,s$3=Symbol(),n$3=new WeakMap;class o$3{constructor(w,O,j){if(this._$cssResult$=!0,j!==s$3)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=w,this.t=O}get styleSheet(){let w=this.o;const O=this.t;if(e$2&&w===void 0){const j=O!==void 0&&O.length===1;j&&(w=n$3.get(O)),w===void 0&&((this.o=w=new CSSStyleSheet).replaceSync(this.cssText),j&&n$3.set(O,w))}return w}toString(){return this.cssText}}const r$2=B=>new o$3(typeof B=="string"?B:B+"",void 0,s$3),i$1=(B,...w)=>{const O=B.length===1?B[0]:w.reduce((j,z,D)=>j+(q=>{if(q._$cssResult$===!0)return q.cssText;if(typeof q=="number")return q;throw Error("Value passed to 'css' function must be a 'css' function result: "+q+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(z)+B[D+1],B[0]);return new o$3(O,B,s$3)},S$1=(B,w)=>{e$2?B.adoptedStyleSheets=w.map(O=>O instanceof CSSStyleSheet?O:O.styleSheet):w.forEach(O=>{const j=document.createElement("style"),z=t$1.litNonce;z!==void 0&&j.setAttribute("nonce",z),j.textContent=O.cssText,B.appendChild(j)})},c$1=e$2?B=>B:B=>B instanceof CSSStyleSheet?(w=>{let O="";for(const j of w.cssRules)O+=j.cssText;return r$2(O)})(B):B;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var s$2;const e$1=window,r$1=e$1.trustedTypes,h$1=r$1?r$1.emptyScript:"",o$2=e$1.reactiveElementPolyfillSupport,n$2={toAttribute(B,w){switch(w){case Boolean:B=B?h$1:null;break;case Object:case Array:B=B==null?B:JSON.stringify(B)}return B},fromAttribute(B,w){let O=B;switch(w){case Boolean:O=B!==null;break;case Number:O=B===null?null:Number(B);break;case Object:case Array:try{O=JSON.parse(B)}catch{O=null}}return O}},a$1=(B,w)=>w!==B&&(w==w||B==B),l$3={attribute:!0,type:String,converter:n$2,reflect:!1,hasChanged:a$1};class d$1 extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this.u()}static addInitializer(w){var O;(O=this.h)!==null&&O!==void 0||(this.h=[]),this.h.push(w)}static get observedAttributes(){this.finalize();const w=[];return this.elementProperties.forEach((O,j)=>{const z=this._$Ep(j,O);z!==void 0&&(this._$Ev.set(z,j),w.push(z))}),w}static createProperty(w,O=l$3){if(O.state&&(O.attribute=!1),this.finalize(),this.elementProperties.set(w,O),!O.noAccessor&&!this.prototype.hasOwnProperty(w)){const j=typeof w=="symbol"?Symbol():"__"+w,z=this.getPropertyDescriptor(w,j,O);z!==void 0&&Object.defineProperty(this.prototype,w,z)}}static getPropertyDescriptor(w,O,j){return{get(){return this[O]},set(z){const D=this[w];this[O]=z,this.requestUpdate(w,D,j)},configurable:!0,enumerable:!0}}static getPropertyOptions(w){return this.elementProperties.get(w)||l$3}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const w=Object.getPrototypeOf(this);if(w.finalize(),this.elementProperties=new Map(w.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const O=this.properties,j=[...Object.getOwnPropertyNames(O),...Object.getOwnPropertySymbols(O)];for(const z of j)this.createProperty(z,O[z])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(w){const O=[];if(Array.isArray(w)){const j=new Set(w.flat(1/0).reverse());for(const z of j)O.unshift(c$1(z))}else w!==void 0&&O.push(c$1(w));return O}static _$Ep(w,O){const j=O.attribute;return j===!1?void 0:typeof j=="string"?j:typeof w=="string"?w.toLowerCase():void 0}u(){var w;this._$E_=new Promise(O=>this.enableUpdating=O),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(w=this.constructor.h)===null||w===void 0||w.forEach(O=>O(this))}addController(w){var O,j;((O=this._$ES)!==null&&O!==void 0?O:this._$ES=[]).push(w),this.renderRoot!==void 0&&this.isConnected&&((j=w.hostConnected)===null||j===void 0||j.call(w))}removeController(w){var O;(O=this._$ES)===null||O===void 0||O.splice(this._$ES.indexOf(w)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((w,O)=>{this.hasOwnProperty(O)&&(this._$Ei.set(O,this[O]),delete this[O])})}createRenderRoot(){var w;const O=(w=this.shadowRoot)!==null&&w!==void 0?w:this.attachShadow(this.constructor.shadowRootOptions);return S$1(O,this.constructor.elementStyles),O}connectedCallback(){var w;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(w=this._$ES)===null||w===void 0||w.forEach(O=>{var j;return(j=O.hostConnected)===null||j===void 0?void 0:j.call(O)})}enableUpdating(w){}disconnectedCallback(){var w;(w=this._$ES)===null||w===void 0||w.forEach(O=>{var j;return(j=O.hostDisconnected)===null||j===void 0?void 0:j.call(O)})}attributeChangedCallback(w,O,j){this._$AK(w,j)}_$EO(w,O,j=l$3){var z;const D=this.constructor._$Ep(w,j);if(D!==void 0&&j.reflect===!0){const q=(((z=j.converter)===null||z===void 0?void 0:z.toAttribute)!==void 0?j.converter:n$2).toAttribute(O,j.type);this._$El=w,q==null?this.removeAttribute(D):this.setAttribute(D,q),this._$El=null}}_$AK(w,O){var j;const z=this.constructor,D=z._$Ev.get(w);if(D!==void 0&&this._$El!==D){const q=z.getPropertyOptions(D),G=typeof q.converter=="function"?{fromAttribute:q.converter}:((j=q.converter)===null||j===void 0?void 0:j.fromAttribute)!==void 0?q.converter:n$2;this._$El=D,this[D]=G.fromAttribute(O,q.type),this._$El=null}}requestUpdate(w,O,j){let z=!0;w!==void 0&&(((j=j||this.constructor.getPropertyOptions(w)).hasChanged||a$1)(this[w],O)?(this._$AL.has(w)||this._$AL.set(w,O),j.reflect===!0&&this._$El!==w&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(w,j))):z=!1),!this.isUpdatePending&&z&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(O){Promise.reject(O)}const w=this.scheduleUpdate();return w!=null&&await w,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var w;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((z,D)=>this[D]=z),this._$Ei=void 0);let O=!1;const j=this._$AL;try{O=this.shouldUpdate(j),O?(this.willUpdate(j),(w=this._$ES)===null||w===void 0||w.forEach(z=>{var D;return(D=z.hostUpdate)===null||D===void 0?void 0:D.call(z)}),this.update(j)):this._$Ek()}catch(z){throw O=!1,this._$Ek(),z}O&&this._$AE(j)}willUpdate(w){}_$AE(w){var O;(O=this._$ES)===null||O===void 0||O.forEach(j=>{var z;return(z=j.hostUpdated)===null||z===void 0?void 0:z.call(j)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(w)),this.updated(w)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(w){return!0}update(w){this._$EC!==void 0&&(this._$EC.forEach((O,j)=>this._$EO(j,this[j],O)),this._$EC=void 0),this._$Ek()}updated(w){}firstUpdated(w){}}d$1.finalized=!0,d$1.elementProperties=new Map,d$1.elementStyles=[],d$1.shadowRootOptions={mode:"open"},o$2==null||o$2({ReactiveElement:d$1}),((s$2=e$1.reactiveElementVersions)!==null&&s$2!==void 0?s$2:e$1.reactiveElementVersions=[]).push("1.4.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),m=/'/g,p=/"/g,$=/^(?:script|style|textarea|title)$/i,g=B=>(w,...O)=>({_$litType$:B,strings:w,values:O}),y=g(1),x=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),T=new WeakMap,A=(B,w,O)=>{var j,z;const D=(j=O==null?void 0:O.renderBefore)!==null&&j!==void 0?j:w;let q=D._$litPart$;if(q===void 0){const G=(z=O==null?void 0:O.renderBefore)!==null&&z!==void 0?z:null;D._$litPart$=q=new S(w.insertBefore(r(),G),G,void 0,O!=null?O:{})}return q._$AI(B),q},E=h.createTreeWalker(h,129,null,!1),C=(B,w)=>{const O=B.length-1,j=[];let z,D=w===2?"<svg>":"",q=v;for(let U=0;U<O;U++){const W=B[U];let Q,Y,J=-1,X=0;for(;X<W.length&&(q.lastIndex=X,Y=q.exec(W),Y!==null);)X=q.lastIndex,q===v?Y[1]==="!--"?q=a:Y[1]!==void 0?q=f:Y[2]!==void 0?($.test(Y[2])&&(z=RegExp("</"+Y[2],"g")),q=_):Y[3]!==void 0&&(q=_):q===_?Y[0]===">"?(q=z!=null?z:v,J=-1):Y[1]===void 0?J=-2:(J=q.lastIndex-Y[2].length,Q=Y[1],q=Y[3]===void 0?_:Y[3]==='"'?p:m):q===p||q===m?q=_:q===a||q===f?q=v:(q=_,z=void 0);const se=q===_&&B[U+1].startsWith("/>")?" ":"";D+=q===v?W+l$2:J>=0?(j.push(Q),W.slice(0,J)+"$lit$"+W.slice(J)+o$1+se):W+o$1+(J===-2?(j.push(void 0),U):se)}const G=D+(B[O]||"<?>")+(w===2?"</svg>":"");if(!Array.isArray(B)||!B.hasOwnProperty("raw"))throw Error("invalid template strings array");return[e!==void 0?e.createHTML(G):G,j]};class P{constructor({strings:w,_$litType$:O},j){let z;this.parts=[];let D=0,q=0;const G=w.length-1,U=this.parts,[W,Q]=C(w,O);if(this.el=P.createElement(W,j),E.currentNode=this.el.content,O===2){const Y=this.el.content,J=Y.firstChild;J.remove(),Y.append(...J.childNodes)}for(;(z=E.nextNode())!==null&&U.length<G;){if(z.nodeType===1){if(z.hasAttributes()){const Y=[];for(const J of z.getAttributeNames())if(J.endsWith("$lit$")||J.startsWith(o$1)){const X=Q[q++];if(Y.push(J),X!==void 0){const se=z.getAttribute(X.toLowerCase()+"$lit$").split(o$1),re=/([.?@])?(.*)/.exec(X);U.push({type:1,index:D,name:re[2],strings:se,ctor:re[1]==="."?R:re[1]==="?"?H:re[1]==="@"?I:M})}else U.push({type:6,index:D})}for(const J of Y)z.removeAttribute(J)}if($.test(z.tagName)){const Y=z.textContent.split(o$1),J=Y.length-1;if(J>0){z.textContent=s$1?s$1.emptyScript:"";for(let X=0;X<J;X++)z.append(Y[X],r()),E.nextNode(),U.push({type:2,index:++D});z.append(Y[J],r())}}}else if(z.nodeType===8)if(z.data===n$1)U.push({type:2,index:D});else{let Y=-1;for(;(Y=z.data.indexOf(o$1,Y+1))!==-1;)U.push({type:7,index:D}),Y+=o$1.length-1}D++}}static createElement(w,O){const j=h.createElement("template");return j.innerHTML=w,j}}function V(B,w,O=B,j){var z,D,q,G;if(w===x)return w;let U=j!==void 0?(z=O._$Cl)===null||z===void 0?void 0:z[j]:O._$Cu;const W=d(w)?void 0:w._$litDirective$;return(U==null?void 0:U.constructor)!==W&&((D=U==null?void 0:U._$AO)===null||D===void 0||D.call(U,!1),W===void 0?U=void 0:(U=new W(B),U._$AT(B,O,j)),j!==void 0?((q=(G=O)._$Cl)!==null&&q!==void 0?q:G._$Cl=[])[j]=U:O._$Cu=U),U!==void 0&&(w=V(B,U._$AS(B,w.values),U,j)),w}class N{constructor(w,O){this.v=[],this._$AN=void 0,this._$AD=w,this._$AM=O}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(w){var O;const{el:{content:j},parts:z}=this._$AD,D=((O=w==null?void 0:w.creationScope)!==null&&O!==void 0?O:h).importNode(j,!0);E.currentNode=D;let q=E.nextNode(),G=0,U=0,W=z[0];for(;W!==void 0;){if(G===W.index){let Q;W.type===2?Q=new S(q,q.nextSibling,this,w):W.type===1?Q=new W.ctor(q,W.name,W.strings,this,w):W.type===6&&(Q=new L(q,this,w)),this.v.push(Q),W=z[++U]}G!==(W==null?void 0:W.index)&&(q=E.nextNode(),G++)}return D}m(w){let O=0;for(const j of this.v)j!==void 0&&(j.strings!==void 0?(j._$AI(w,j,O),O+=j.strings.length-2):j._$AI(w[O])),O++}}class S{constructor(w,O,j,z){var D;this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=w,this._$AB=O,this._$AM=j,this.options=z,this._$C_=(D=z==null?void 0:z.isConnected)===null||D===void 0||D}get _$AU(){var w,O;return(O=(w=this._$AM)===null||w===void 0?void 0:w._$AU)!==null&&O!==void 0?O:this._$C_}get parentNode(){let w=this._$AA.parentNode;const O=this._$AM;return O!==void 0&&w.nodeType===11&&(w=O.parentNode),w}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(w,O=this){w=V(this,w,O),d(w)?w===b||w==null||w===""?(this._$AH!==b&&this._$AR(),this._$AH=b):w!==this._$AH&&w!==x&&this.$(w):w._$litType$!==void 0?this.T(w):w.nodeType!==void 0?this.k(w):c(w)?this.O(w):this.$(w)}S(w,O=this._$AB){return this._$AA.parentNode.insertBefore(w,O)}k(w){this._$AH!==w&&(this._$AR(),this._$AH=this.S(w))}$(w){this._$AH!==b&&d(this._$AH)?this._$AA.nextSibling.data=w:this.k(h.createTextNode(w)),this._$AH=w}T(w){var O;const{values:j,_$litType$:z}=w,D=typeof z=="number"?this._$AC(w):(z.el===void 0&&(z.el=P.createElement(z.h,this.options)),z);if(((O=this._$AH)===null||O===void 0?void 0:O._$AD)===D)this._$AH.m(j);else{const q=new N(D,this),G=q.p(this.options);q.m(j),this.k(G),this._$AH=q}}_$AC(w){let O=T.get(w.strings);return O===void 0&&T.set(w.strings,O=new P(w)),O}O(w){u(this._$AH)||(this._$AH=[],this._$AR());const O=this._$AH;let j,z=0;for(const D of w)z===O.length?O.push(j=new S(this.S(r()),this.S(r()),this,this.options)):j=O[z],j._$AI(D),z++;z<O.length&&(this._$AR(j&&j._$AB.nextSibling,z),O.length=z)}_$AR(w=this._$AA.nextSibling,O){var j;for((j=this._$AP)===null||j===void 0||j.call(this,!1,!0,O);w&&w!==this._$AB;){const z=w.nextSibling;w.remove(),w=z}}setConnected(w){var O;this._$AM===void 0&&(this._$C_=w,(O=this._$AP)===null||O===void 0||O.call(this,w))}}class M{constructor(w,O,j,z,D){this.type=1,this._$AH=b,this._$AN=void 0,this.element=w,this.name=O,this._$AM=z,this.options=D,j.length>2||j[0]!==""||j[1]!==""?(this._$AH=Array(j.length-1).fill(new String),this.strings=j):this._$AH=b}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(w,O=this,j,z){const D=this.strings;let q=!1;if(D===void 0)w=V(this,w,O,0),q=!d(w)||w!==this._$AH&&w!==x,q&&(this._$AH=w);else{const G=w;let U,W;for(w=D[0],U=0;U<D.length-1;U++)W=V(this,G[j+U],O,U),W===x&&(W=this._$AH[U]),q||(q=!d(W)||W!==this._$AH[U]),W===b?w=b:w!==b&&(w+=(W!=null?W:"")+D[U+1]),this._$AH[U]=W}q&&!z&&this.P(w)}P(w){w===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,w!=null?w:"")}}class R extends M{constructor(){super(...arguments),this.type=3}P(w){this.element[this.name]=w===b?void 0:w}}const k=s$1?s$1.emptyScript:"";class H extends M{constructor(){super(...arguments),this.type=4}P(w){w&&w!==b?this.element.setAttribute(this.name,k):this.element.removeAttribute(this.name)}}class I extends M{constructor(w,O,j,z,D){super(w,O,j,z,D),this.type=5}_$AI(w,O=this){var j;if((w=(j=V(this,w,O,0))!==null&&j!==void 0?j:b)===x)return;const z=this._$AH,D=w===b&&z!==b||w.capture!==z.capture||w.once!==z.once||w.passive!==z.passive,q=w!==b&&(z===b||D);D&&this.element.removeEventListener(this.name,this,z),q&&this.element.addEventListener(this.name,this,w),this._$AH=w}handleEvent(w){var O,j;typeof this._$AH=="function"?this._$AH.call((j=(O=this.options)===null||O===void 0?void 0:O.host)!==null&&j!==void 0?j:this.element,w):this._$AH.handleEvent(w)}}class L{constructor(w,O,j){this.element=w,this.type=6,this._$AN=void 0,this._$AM=O,this.options=j}get _$AU(){return this._$AM._$AU}_$AI(w){V(this,w)}}const Z=i.litHtmlPolyfillSupport;Z==null||Z(P,S),((t=i.litHtmlVersions)!==null&&t!==void 0?t:i.litHtmlVersions=[]).push("2.3.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,stripe_payment_request_default=styles3;function isStripeDisplayItem(B){return B.tagName.toLowerCase()==="stripe-display-item"}function datasetToStripeDisplayItem({dataset:{amount:B,label:w,pending:O}}){return{label:w,amount:parseInt(B),...O!==void 0&&{pending:O==="true"}}}function datasetToStripeShippingOption({dataset:{amount:B,detail:w,...O}}){return{amount:parseInt(B),detail:w,...O}}function mapDataset(B){return isStripeDisplayItem(B)?datasetToStripeDisplayItem(B):datasetToStripeShippingOption(B)}var _displayItems,_shippingOptions,StripePaymentRequest=class extends StripeBase{constructor(){super(...arguments),this.canMakePayment=null,__privateAdd(this,_displayItems,void 0),this.paymentIntent=null,this.paymentRequest=null,this.pending=!1,__privateAdd(this,_shippingOptions,void 0),this.buttonType="default",this.buttonTheme="dark",this.complete=async(B,w)=>{const{error:O=null}={...B},j=O||w?"fail":"success";return B.complete(j),this.fire(j,B),w?{error:w}:B}}get displayItems(){const B=__privateGet(this,_displayItems);return Array.isArray(B)?B:this.parseDatasets("stripe-display-item")}set displayItems(B){const w=this.displayItems;__privateSet(this,_displayItems,B),this.requestUpdate("displayItems",w)}get shippingOptions(){const B=__privateGet(this,_shippingOptions);return Array.isArray(B)?B:this.parseDatasets("stripe-shipping-option")}set shippingOptions(B){const w=this.shippingOptions;__privateSet(this,_shippingOptions,B),this.requestUpdate("shippingOptions",w)}reset(){super.reset(),readonly.set(this,{paymentIntent:null})}updated(B){super.updated(B),B.has("generate")&&this.initPaymentRequestListeners(),B.has("amount")&&this.updatePaymentRequest()}getStripePaymentRequestOptions(){const{country:B,currency:w,displayItems:O,shippingOptions:j,requestShipping:z,requestPayerEmail:D,requestPayerName:q,requestPayerPhone:G,label:U="",amount:W=0}=this;return{country:B,currency:w,displayItems:O,requestPayerEmail:D,requestPayerName:q,requestPayerPhone:G,requestShipping:z,shippingOptions:j,total:{label:U,amount:W}}}async initElement(){await this.initPaymentRequest(),await this.initPaymentRequestListeners(),await this.initPaymentRequestButton()}async initPaymentRequest(){if(!this.stripe)return;const B=this.getStripePaymentRequestOptions(),w=this.stripe.paymentRequest(B),O=await w.canMakePayment();readonly.set(this,{paymentRequest:w,canMakePayment:O}),await this.updateComplete,this.canMakePayment||this.fire("unsupported")}async initPaymentRequestButton(){const{buttonTheme:B,buttonType:w,canMakePayment:O}=this;if(!O||!this.elements)return;const j="--stripe-payment-request-button-height",D={paymentRequestButton:{height:this.getCSSCustomPropertyValue(j)||"40px",theme:B,type:w}},q=this.elements.create("paymentRequestButton",{paymentRequest:this.paymentRequest,style:D});readonly.set(this,{element:q}),await this.updateComplete}async initPaymentRequestListeners(){if(!!this.canMakePayment)switch(this.paymentRequest.on("click",this.updatePaymentRequest),this.paymentRequest.on("cancel",this.onCancel),this.paymentRequest.on("shippingaddresschange",this.onShippingaddresschange),this.paymentRequest.on("shippingoptionchange",this.onShippingoptionchange),this.generate){case"payment-method":this.paymentRequest.on("paymentmethod",this.onPaymentResponse);break;case"source":this.paymentRequest.on("source",this.onPaymentResponse);break;case"token":this.paymentRequest.on("token",this.onPaymentResponse);break}}async updatePaymentRequest(){if(!this.paymentRequest)return;const{currency:B,total:w,displayItems:O,shippingOptions:j}=this.getStripePaymentRequestOptions();this.paymentRequest.update({currency:B,total:w,displayItems:O,shippingOptions:j})}onCancel(){this.fire("cancel")}async onPaymentResponse(B){const{error:w=null,paymentMethod:O=null,source:j=null,token:z=null}={...B};readonly.set(this,{error:w,paymentMethod:O,source:j,token:z}),this.clientSecret&&!w?this.confirmPaymentIntent(B):this.complete(B)}async confirmPaymentIntent(B){var D;const w={payment_method:this.paymentMethod.id},O=await this.confirmCardPayment(w,{handleActions:!1}).then(({error:q})=>this.complete(B,q)).then(throwResponseError).then(()=>this.confirmCardPayment()).then(throwResponseError).catch(q=>({error:q})),{error:j=null}=O,z=(D=O.paymentIntent)!=null?D:null;readonly.set(this,{error:j,paymentIntent:z}),await this.updateComplete}async confirmCardPayment(B,w){return this.stripe.confirmCardPayment(this.clientSecret,B,w)}onShippingaddresschange(B){this.fire("shippingaddresschange",B)}onShippingoptionchange(B){this.fire("shippingoptionchange",B)}parseDatasets(B){const w=[...this.querySelectorAll(B)];return w.length?w.map(mapDataset):[]}};_displayItems=new WeakMap;_shippingOptions=new WeakMap;StripePaymentRequest.is="stripe-payment-request";StripePaymentRequest.styles=[shared_default,stripe_payment_request_default];__decorateClass([e$3({type:Number,reflect:!0})],StripePaymentRequest.prototype,"amount",2);__decorateClass([notify,readonly,e$3({type:Boolean,attribute:"can-make-payment",reflect:!0})],StripePaymentRequest.prototype,"canMakePayment",2);__decorateClass([e$3({type:String})],StripePaymentRequest.prototype,"country",2);__decorateClass([e$3({type:String})],StripePaymentRequest.prototype,"currency",2);__decorateClass([e$3({type:Array})],StripePaymentRequest.prototype,"displayItems",1);__decorateClass([e$3({type:String,reflect:!0})],StripePaymentRequest.prototype,"label",2);__decorateClass([notify,readonly,e$3({type:Object,attribute:"payment-intent"})],StripePaymentRequest.prototype,"paymentIntent",2);__decorateClass([readonly,e$3({type:Object,attribute:"payment-request"})],StripePaymentRequest.prototype,"paymentRequest",2);__decorateClass([e$3({type:Boolean,reflect:!0})],StripePaymentRequest.prototype,"pending",2);__decorateClass([e$3({type:Boolean,attribute:"request-payer-email"})],StripePaymentRequest.prototype,"requestPayerEmail",2);__decorateClass([e$3({type:Boolean,attribute:"request-payer-name"})],StripePaymentRequest.prototype,"requestPayerName",2);__decorateClass([e$3({type:Boolean,attribute:"request-payer-phone"})],StripePaymentRequest.prototype,"requestPayerPhone",2);__decorateClass([e$3({type:Boolean,attribute:"request-shipping"})],StripePaymentRequest.prototype,"requestShipping",2);__decorateClass([e$3({type:Array})],StripePaymentRequest.prototype,"shippingOptions",1);__decorateClass([e$3({type:String,attribute:"button-type"})],StripePaymentRequest.prototype,"buttonType",2);__decorateClass([e$3({type:String,attribute:"button-theme"})],StripePaymentRequest.prototype,"buttonTheme",2);__decorateClass([bound],StripePaymentRequest.prototype,"onCancel",1);__decorateClass([bound],StripePaymentRequest.prototype,"onPaymentResponse",1);__decorateClass([bound],StripePaymentRequest.prototype,"confirmPaymentIntent",1);__decorateClass([bound],StripePaymentRequest.prototype,"confirmCardPayment",1);__decorateClass([bound],StripePaymentRequest.prototype,"onShippingaddresschange",1);__decorateClass([bound],StripePaymentRequest.prototype,"onShippingoptionchange",1);StripePaymentRequest=__decorateClass([e$4("stripe-payment-request")],StripePaymentRequest);const VITE_CommerceKey$1="pk_246737d87ea305a2a8a9c063b89d7d84a229bda1ca9c2",VITE_StripeKey$1="pk_live_51IbCVzHMfdeKt5zM7eq7VimKhvoak6vkeati23YVPavrVNnYj4oPiE36KBYpy5LYzudDioM5AONK9r26IRA9Tysy00ibywIvec",commerce$1=new lib(`${VITE_CommerceKey$1}`,!0);var allProducts$1=[],currentShopProduct$1,shopPage=1,currentCart$1,cartEmpty$1=!0,selectedPSize$1="",countriesObj$1={},variantAbbr="",countriesAdded=!1,shippingMethodValue,shippingId="",card$1,stripeElements,pComplete;class mobileShop1 extends HTMLElement{constructor(){super();ae(this,"closeMobileShop",()=>{document.getElementById("mobileShop").style.display="none"});ae(this,"loadShop",async()=>{this.shadow.getElementById("LoadBG").style.display="grid";var O=this.shadow.getElementById("mb1");await commerce$1.products.list({limit:100,sortDirection:"desc"}).then(j=>allProducts$1.push(j.data)),allProducts$1[0].forEach(j=>{var z=document.createElement("div");z.setAttribute("class","productContainer"),z.setAttribute("id",j.id),this.shadow.getElementById("productEdition").addEventListener("click",this.toggleTerms),z.addEventListener("click",this.viewProduct),O.appendChild(z),z.innerHTML=`
    ...
    `,productsloaded=!0,this.shadow.getElementById("LoadBG").style.display="none"}),commerce$1.cart.empty()});ae(this,"viewProduct",O=>{var j=O.target.parentElement.id;this.shadow.getElementById("scroll").style.display="block",currentShopProduct$1=allProducts$1[0].filter(q=>q.id.includes(`${j}`)),this.shadow.getElementById("mb2").style.display="block",shopPage=2,this.shadow.getElementById("pName").innerHTML=`
        ${currentShopProduct$1[0].name}`,currentShopProduct$1[0].categories.forEach(q=>{q.name==="\xC9"&&(this.shadow.getElementById("eSymbol1").style.display="block"),q.name==="S\xC9"&&(this.shadow.getElementById("eSymbol2").style.display="block")}),this.shadow.getElementById("pDesc").innerHTML=currentShopProduct$1[0].description,this.shadow.getElementById("proPrice").innerHTML=currentShopProduct$1[0].price.formatted_with_symbol,currentShopProduct$1[0].inventory.available===0&&(this.shadow.getElementById("archived").style.display="grid");var z=this.shadow.getElementById("allImages"),D=0;this.shadow.getElementById("mainImageCont").src=`${currentShopProduct$1[0].assets[0].url}`,currentShopProduct$1[0].assets.forEach(q=>{if(D<=3){var G=document.createElement("img");G.setAttribute("src",`${q.url}`),G.setAttribute("id",`${q.url}`),G.addEventListener("click",this.changeToMainPic),z.appendChild(G),D++}q.filename==="sizeChart.png"&&(this.shadow.getElementById("noti").innerHTML=`
            ...
            `,this.shadow.getElementById("termsButton").addEventListener("click",this.toggleTerms);var D=this.shadow.querySelectorAll(".changeQty");D.forEach(q=>{q.addEventListener("click",this.changeQty)}),z.setAttribute("id",`${j.id}Parent`)})});ae(this,"toggleTerms",()=>{this.noti1(),this.shadow.getElementById("noti").innerHTML=`
        <div id="terms">
         ...
         `});ae(this,"checkQuantity",O=>{var j=allProducts$1[0].filter(z=>z.id===O);return j[0].inventory.available});ae(this,"changeQty",O=>{this.shadow.getElementById("LoadBG").style.display="grid";var j=O.target.getAttribute("id"),z=O.target.parentElement.getAttribute("name"),D=this.checkQuantity(z);if(O.target.getAttribute("name")==="inc"){var q=currentCart$1.line_items.filter(G=>G.id===j);if(D>=2&&q[0].quantity<=D-1){commerce$1.cart.update(`${j}`,{quantity:q[0].quantity+1}).then(G=>{this.shadow.getElementById("cartItems").innerHTML="",this.shadow.getElementById("LoadBG").style.display="none",this.shadow.getElementById("totalPrice").innerHTML=G.cart.subtotal.formatted_with_symbol,currentCart$1=G.cart,this.viewCart()});return}else O.target.style.opacity=".3",this.shadow.getElementById("LoadBG").style.display="none"}if(O.target.getAttribute("name")==="dec"){var q=currentCart$1.line_items.filter(U=>U.id===j);commerce$1.cart.update(`${j}`,{quantity:q[0].quantity-1}).then(U=>{if(this.shadow.getElementById("cartItems").innerHTML="",this.shadow.getElementById("LoadBG").style.display="none",this.shadow.getElementById("totalPrice").innerHTML=U.cart.subtotal.formatted_with_symbol,currentCart$1=U.cart,this.viewCart(),U.cart.total_items===0){var W=this.shadow.getElementById("cartStatus");cartEmpty$1=!0,this.return(),W.innerHTML="CART EMPTY",W.removeEventListener("click",this.viewCart),this.shadow.getElementById("cartStatus").removeEventListener("click",this.checkout),selectedPSize$1=""}});return}});ae(this,"shipping",()=>{shopPage=4;var O=this.shadow.getElementById("shippingButton"),j=this.shadow.getElementById("cartStatus");this.shadow.getElementById("checkoutInputs").style.display="grid",O.innerHTML="VIEW CART",O.removeAttribute("click",this.shipping),O.addEventListener("click",this.return),j.innerHTML="PAY NOW",j.addEventListener("click",this.checkout),countriesAdded===!1&&(countriesAdded=!0,commerce$1.services.localeListCountries().then(z=>{countriesObj$1=z.countries,Object.keys(z.countries).forEach(D=>{var q=document.createElement("option"),G=this.shadow.getElementById("inputCN");q.setAttribute("value",D),q.setAttribute("title",D),q.innerHTML=`${countriesObj$1[D].substr(0,20)}`,G.appendChild(q)})})),this.shadow.getElementById("inputCN").addEventListener("change",this.states),this.shadow.getElementById("card-element").innerHTML=`
        <stripe-elements publishable-key="${VITE_StripeKey$1}" id="sCard" hide-postal-code
                 show-error generate="token" action="/my-endpoint">
        </stripe-elements>`,this.shadow.getElementById("sCard").addEventListener("ready",z=>{card$1=z.path[0].element,z.path[0].stripe.createToken(card$1),stripeElements=z.path[0].stripe})});ae(this,"states",()=>{var O=this.shadow.getElementById("inputCN"),j=O.options[O.selectedIndex].value,z=O.options[O.selectedIndex].title,D=this.shadow.getElementById("totalPrice");this.shadow.getElementById("inputST").innerHTML="",j==="US"&&(this.shadow.getElementById("inputSP").value="$0.00 Free Shipping",shippingMethodValue=1,D.innerHTML=currentCart$1.subtotal.formatted_with_symbol),j!="US"&&(this.shadow.getElementById("inputSP").value="$70.00 Intl Shipping",shippingMethodValue=3,D.innerHTML=`$${currentCart$1.subtotal.raw+70}.00`),z==="US2"&&(this.shadow.getElementById("inputSP").value="$130.00 - Next Day",shippingMethodValue=2,D.innerHTML=`$${currentCart$1.subtotal.raw+130}.00`),commerce$1.services.localeListSubdivisions(j).then(q=>{var G=q.subdivisions;Object.keys(q.subdivisions).forEach(U=>{var W=document.createElement("option"),Q=this.shadow.getElementById("inputST");if(Object.keys(q.subdivisions).length<=1){var Y=document.createElement("option");Y.innerHTML="Not Available.",O.options[O.selectedIndex].innerHTML="Select Country",this.shadow.getElementById("inputST").appendChild(Y)}else W.setAttribute("value",G[U]),W.setAttribute("id",U),W.innerHTML=G[U].substring(0,20),Q.appendChild(W)})})});ae(this,"checkout",async()=>{var O=this.shadow.getElementById("inputFN").value,j=this.shadow.getElementById("inputLN").value,z=this.shadow.getElementById("inputBD").value;this.shadow.getElementById("inputSP").value;var D=this.shadow.getElementById("inputEM").value,q=this.shadow.getElementById("inputCY").value,G=this.shadow.getElementById("inputZC").value,U=this.shadow.getElementById("inputSA").value,W=this.shadow.getElementById("inputCN"),Q=this.shadow.getElementById("inputST"),Y=W.options[W.selectedIndex].value,J=Q.options[Q.selectedIndex].id,X=this.shadow.getElementById("cartStatus");X.removeEventListener("click",this.checkout),this.shadow.getElementById("LoadBG").innerHTML='<div class="loader"></div>',this.shadow.getElementById("LoadBG").style.display="grid",setTimeout(()=>{pComplete===!1&&(this.shadow.getElementById("LoadBG").addEventListener("click",this.return),this.shadow.getElementById("LoadBG").innerHTML="<p style='text-align:center;padding-left:5%;padding-right:5%;font-family:BS-R; cursor:pointer;'>There was a problem processing your order.<br>Please check your billing information and try again.<br><br><br>If the problem persist, please email<br> info@scoge.co for help with your order.<br><br>( RETURN )<p>")},2e4),await commerce$1.checkout.generateToken(currentCart$1.id,{type:"cart"}).catch(()=>{console.log("Couldnt Generate Token"),this.shadow.getElementById("LoadBG").addEventListener("click",this.return),this.shadow.getElementById("LoadBG").innerHTML="<p style='text-align:center;padding-left:5%;padding-right:5%;font-family:BS-R; cursor:pointer;'>There was a problem processing your order.<br>Please check your Internet Connection and try again.<br><br><br>If the problem persist, please email<br> info@scoge.co for help with your order.<br><br>( RETURN )<p>"}).then(async se=>{commerce$1.checkout.getShippingOptions(se.id,{country:Y}).then(async re=>{shippingMethodValue===1&&(shippingId=re[0].id),shippingMethodValue===3&&(shippingId=re[0].id),shippingMethodValue===2&&(shippingId=re[1].id);var de=`${O} ${j}`;const pe=await stripeElements.createPaymentMethod({type:"card",card:card$1}).catch(ue=>{console.log(`THIS ERROR ${ue}`),this.shadow.getElementById("LoadBG").style.display="none",X.addEventListener("click",this.checkout)});if(pe.error){this.shadow.getElementById("LoadBG").style.display="none",console.log(pe.error.message),this.shadow.getElementById("LoadBG").addEventListener("click",this.return),this.shadow.getElementById("LoadBG").innerHTML=`<p style='text-align:center;padding-left:5%;padding-right:5%;font-family:BS-R; cursor:pointer;'>There was a problem processing your order.<br><br>${pe.error.message}<br><br><br>If the problem persist, please email<br> info@scoge.co for help with your order.<br><br>( RETURN )<p>`;return}try{const ue=await commerce$1.checkout.capture(se.id,{customer:{firstname:`${O}`,lastname:`${j}`,email:`${D}`},extra_fields:{extr_DWy4oG4dY56Jx2:`${U}`},shipping:{name:`${de}`,street:`${z}`,town_city:`${q}`,county_state:`${J}`,postal_zip_code:`${G}`,country:`${Y}`},fulfillment:{shipping_method:`${shippingId}`},billing:{name:`${de}`,street:`${z}`,town_city:`${q}`,county_state:`${J}`,postal_zip_code:`${G}`,country:`${Y}`},payment:{gateway:"stripe",stripe:{payment_method_id:pe.paymentMethod.id}}});this.return,this.purchaseComplete(),this.noti1(),this.shadow.getElementById("noti").innerHTML=`
